package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_348:IRoomObjectController;
      ...
      {
         if(this.var_348 == param1)
         {
            return;
         }
         if(this.var_348 != null)
         {
            this.var_348.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_348 = param1;
            this.var_348.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_348 != null)
            {
               this.var_348.setLocation(param1.loc);
               this.var_348.setDirection(param1.dir);
            }
         }
      }
   }
