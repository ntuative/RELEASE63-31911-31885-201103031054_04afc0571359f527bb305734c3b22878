package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_348:IRoomObject;
      
      private var var_713:IGraphicAssetCollection;
      
      protected var var_441:int = -1;
      
      protected var var_164:int = -1;
      
      protected var var_183:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_189.length > 0)
            {
               _loc1_ = this.var_189[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_713.removeReference();
         }
         this.var_713 = param1;
         if(this.var_713 != null)
         {
            this.var_713.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_189.length > param1)
         {
            _loc2_ = this.var_189[this.var_189.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_189.length)
         {
      ...
      {
         this.var_441 = 4294967295;
         this.var_164 = 4294967295;
         this.var_183 = -1;
      }
