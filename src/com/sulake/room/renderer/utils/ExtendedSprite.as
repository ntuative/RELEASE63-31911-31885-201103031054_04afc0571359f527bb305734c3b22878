package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      private var var_1322:int = 128;
      
      private var var_1321:Boolean = false;
      
      private var var_2773:Point;
      ...
      {
         if(param1 != this.var_1630 || param2 != this.var_1631)
         {
      ...
      {
         if(this.var_1322 > 255 || bitmapData == null)
         {
            return false;
         }
