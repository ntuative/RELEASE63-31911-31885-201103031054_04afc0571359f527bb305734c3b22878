package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      private var var_2664:int = -1;
      
      private var var_1198:Vector3d;
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1904 || param1.getUpdateID() != this.var_2664)
         {
            this.var_2664 = param1.getUpdateID();
            if(param2.updateId != this.var_1904 || _loc4_.x != this.var_1198.x || _loc4_.y != this.var_1198.y || _loc4_.z != this.var_1198.z)
            {
               this.var_1904 = param2.updateId;
               this.var_1198.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2665 = _loc3_;
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  if(_loc8_ != null)
                  {
                     this.var_369 = new Vector3d(_loc5_.x,_loc5_.y,_loc8_.z);
                  }
                  else
                  {
