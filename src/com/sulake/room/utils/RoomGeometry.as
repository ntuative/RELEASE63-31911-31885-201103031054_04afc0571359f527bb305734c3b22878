package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_830:Number = 64;
      
      public static const const_1087:Number = 32;
      ...
      private var var_154:Vector3d;
      
      private var var_1057:Vector3d;
      
      private var _scale:Number = 1.0;
      
      private var var_400:Number = 1.0;
      
      private var var_401:Number = 1.0;
      
      private var var_402:Number = 1.0;
      
      private var var_1620:Number = 1.0;
      
      private var var_1622:Number = 1.0;
      
      private var var_1621:Number = 1.0;
      
      private var var_75:Vector3d;
      
      private var var_235:Vector3d;
      
      private var var_2770:Number = -500.0;
      
      private var var_2771:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1057 = new Vector3d();
         this.var_1620 = 1;
         this.var_1622 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1621 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_154.x,this.var_154.y,this.var_154.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_75.x * this.var_400,this.var_75.y * this.var_401,this.var_75.z * this.var_402);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_235.x,this.var_235.y,this.var_235.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_400 != param1 * this.var_1620)
         {
            this.var_400 = param1 * this.var_1620;
            ++this.var_145;
         }
      }
      ...
      {
         if(this.var_401 != param1 * this.var_1622)
         {
            this.var_401 = param1 * this.var_1622;
            ++this.var_145;
         }
      }
      ...
      {
         if(this.var_402 != param1 * this.var_1621)
         {
            this.var_402 = param1 * this.var_1621;
            ++this.var_145;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_75.x;
         var _loc3_:Number = this.var_75.y;
         var _loc4_:Number = this.var_75.z;
         this.var_75.assign(param1);
         this.var_75.x /= this.var_400;
         this.var_75.y /= this.var_401;
         this.var_75.z /= this.var_402;
         if(this.var_75.x != _loc2_ || this.var_75.y != _loc3_ || this.var_75.z != _loc4_)
         {
            ++this.var_145;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_235.x;
         var _loc3_:Number = this.var_235.y;
         var _loc4_:Number = this.var_235.z;
         this.var_235.assign(param1);
         if(this.var_235.x != _loc2_ || this.var_235.y != _loc3_ || this.var_235.z != _loc4_)
         {
            ++this.var_145;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_154.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_153.assign(_loc19_);
            this.var_154.assign(_loc20_);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_472 != null)
         {
            ...
            this.var_472.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_472.add(_loc3_,_loc4_);
            ++this.var_145;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_472 != null)
         {
            ...
            return this.var_472.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1057.assign(_loc22_);
         }
         else
         {
            this.var_1057.assign(_loc17_);
         }
         ++this.var_145;
      }
      ...
      {
         if(param1 == null || this.var_154 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_154,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_154);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,this.var_75);
         _loc2_.x *= this.var_400;
         _loc2_.y *= this.var_401;
         _loc2_.z *= this.var_402;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1057);
         if(_loc3_ < this.var_2770 || _loc3_ > this.var_2771)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,this.var_75);
            _loc2_.add(_loc6_);
            _loc2_.x *= this.var_400;
            _loc2_.y *= this.var_401;
            _loc2_.z *= this.var_402;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1057);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_75.x * this.var_400,this.var_75.y * this.var_401,this.var_75.z * this.var_402);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_154;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_400,param2.y * this.var_401,param2.z * this.var_402);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_400,param3.y * this.var_401,param3.z * this.var_402);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_400,param4.y * this.var_401,param4.z * this.var_402);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1087;
         }
         else
         {
            this.scale = const_830;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_830;
      }
