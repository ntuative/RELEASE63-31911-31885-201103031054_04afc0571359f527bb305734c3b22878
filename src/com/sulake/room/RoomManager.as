package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1117:int = 2;
      ...
      private var var_161:IRoomManagerListener;
      
      private var var_2830:IRoomContentLoader;
      
      private var var_627:IRoomObjectFactory = null;
      
      private var var_512:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1182:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_626 = [];
         this.var_603 = [];
         events.addEventListener(RoomContentLoadedEvent.const_350,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_573,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_627 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_627 == null || this.var_512 == null)
         {
            return;
         }
         ...
         {
            _loc1_ = this.var_1182;
            this.var_1182 = null;
            this.initialize(_loc1_,this.var_161);
         }
      }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_626.indexOf(_loc5_) < 0)
            {
               this.var_52.loadObjectContent(_loc5_,events);
               this.var_626.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1117;
         return true;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_603.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_603.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_603[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_512.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_512.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_627.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_627 != null)
         {
            return this.var_627.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_832)
         {
            return;
         }
         if(this.var_52 == null)
         {
            this._state = const_832;
            return;
         }
         if(this.var_52.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_626.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_626.splice(_loc2_,1);
            }
            if(this.var_626.length == 0)
            {
               ...
               {
                  this.var_161.roomManagerInitialized();
               }
            }
         }
         else
         {
            this._state = const_832;
            this.var_161.roomManagerInitialized(false);
         }
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(_loc2_ == null)
         {
            if(this.var_161 != null)
            {
               this.var_161.contentLoaded(null,false);
            }
            return;
         }
         ...
         if(_loc3_ == null)
         {
            if(this.var_161 != null)
            {
               this.var_161.contentLoaded(_loc2_,false);
            }
            return;
         }
         ...
         if(this.var_161 != null)
         {
            this.var_161.contentLoaded(_loc2_,true);
         }
         if(this.var_626.length > 0)
         {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(this.var_52 == null || this.var_512 == null)
         {
            return;
         }
         ...
         var _loc5_:* = null;
         var _loc6_:int = this.var_117.length - 1;
         while(_loc6_ >= 0)
         {
            _loc7_ = this.var_117.getWithIndex(_loc6_) as RoomInstance;
            _loc8_ = this.var_117.getKey(_loc6_);
            if(_loc7_ != null)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = this.var_512.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = this.var_512.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_627.createRoomObjectLogic(_loc18_);
                                 ...
                                 if(this.var_161 != null)
                                 {
                                    this.var_161.objectInitialized(_loc8_,_loc14_.getId(),_loc11_);
                                 }
                              }
                           }
                           else
