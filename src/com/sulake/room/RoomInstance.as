package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_152:IRoomRendererBase;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_252 != null)
         {
            ...
            {
               _loc3_ = this.var_252.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_544)
            {
               delete this.var_544[_loc1_];
            }
            this.var_544 = null;
         }
         if(this.var_541 != null)
         {
            for(_loc1_ in this.var_541)
            {
               delete this.var_541[_loc1_];
            }
            this.var_541 = null;
         }
         this.var_1266 = [];
      ...
      {
         return this.var_544[param1];
      }
      
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         if(this.var_1267.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1267.push(param1);
         }
         if(this.var_544[param1] != param2)
         {
            this.var_544[param1] = param2;
         }
      }
      ...
      {
         if(this.var_1266.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
         {
            this.var_1266.push(param1);
         }
         if(this.var_541[param1] != param2)
         {
            this.var_541[param1] = param2;
         }
      }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_603.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_603[_loc2_]);
      ...
      public function createObjectInternal(param1:int, param2:int, param3:int) : IRoomObject
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_152 != null)
            {
               this.var_152.feedRoomObject(_loc5_);
            }
            return _loc5_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_152)
               {
                  this.var_152.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_152)
                  {
                     this.var_152.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_152.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      {
         return this.var_252.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_252.getValue(_loc2_) != null)
         {
            return this.var_252.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_252.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_252.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_252.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_252.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
