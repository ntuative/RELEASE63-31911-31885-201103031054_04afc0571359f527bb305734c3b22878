package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_784:String = "RCL_LOADER_READY";
      
      private static const const_331:String = "RCL_PUBLICROOM_";
      
      private static const const_1690:int = 0;
      
      private static const const_935:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_414:String = "place_holder";
      
      private static const const_595:String = "wall_place_holder";
      
      private static const const_596:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_414;
      
      private static const const_597:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_936:String = "selection_arrow";
      ...
      {
         this.var_340 = new Dictionary();
         this._wallItems = new Dictionary();
         this.var_403 = new Dictionary();
         this.var_2225 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         ...
         this.var_405 = new Map();
         this.var_705 = new Map();
         this.var_1318 = new Map();
      }
      ...
      {
         if(this._state >= const_935)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2222 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2223 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2221 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function initPetData() : void
      {
         ...
         {
            this.var_403[_loc3_] = _loc2_;
            this.var_878.add(_loc2_,_loc3_);
            _loc2_++;
         }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_276.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_475 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_475.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_405.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_405.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_340)
            {
               delete this.var_340[_loc1_];
            }
            this.var_340 = null;
         }
         ...
         {
            for(_loc1_ in this.var_403)
            {
               delete this.var_403[_loc1_];
            }
            this.var_403 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_704.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_404.add(_loc3_,_loc4_);
               if(this.var_340[_loc7_] == null)
               {
                  this.var_340[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_577.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_578.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_578.remove(_loc7_);
               this.var_578.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2224)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_784));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_474 != null)
         {
            this.var_474.remove(param1);
            this.var_474.add(param1,param2);
         }
         if(this.var_473 != null)
         {
            this.var_473.remove(param2);
            this.var_473.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_474 != null)
         {
            _loc2_ = this.var_474.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_473 != null)
         {
            _loc2_ = this.var_473.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_188 != null && (this.var_188.type == param1 || this.var_188.hasWorldType(param1)))
         {
      ...
      {
         return [const_414,const_595,const_596,const_597,TILE_CURSOR,const_936];
      }
      ...
      {
         var _loc3_:String = this.var_577.getValue(param1) as String;
      ...
      {
         return this.var_878.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_877[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_577.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_704.getValue(param1) != null)
         {
            return this.var_704.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_188 != null && this.var_188.hasWorldType(const_331 + param1))
         {
            return this.var_188.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_189 || param1 == RoomObjectVisualizationEnum.const_66 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_578.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2221 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_340[_loc4_] == null)
                     {
                        this.var_340[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_350,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1318.getValue(param1) != null)
         {
            this.var_188 = this.var_1318.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_863,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2225.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1611);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_403[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_350,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_573,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_403[param1];
            this.var_877.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1318.add(param1,_loc4_);
         this.var_188 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_705.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_705.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_475.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_705.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_475.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_475.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_271 && _loc5_ != RoomObjectLogicEnum.const_189)
         {
            _loc6_ = "@shadow";
      ...
      public function method_4(param1:String) : XML
      {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_512.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_405.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_405.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_405[_loc2_] != null)
         {
            _loc3_ = this.var_405.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_331 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_331 + param1) == RoomObjectCategoryEnum.const_78)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_188.getWorldHeightScale(const_331 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_188 != null)
         {
            return this.var_188.getWorldScale(const_331 + param1);
         }
         return 32;
      }
