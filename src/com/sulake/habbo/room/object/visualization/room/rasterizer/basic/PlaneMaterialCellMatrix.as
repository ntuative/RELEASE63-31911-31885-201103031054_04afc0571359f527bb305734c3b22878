package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1443:int = const_400;
      ...
      public static const const_312:int = const_118;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_674 != null)
         {
            this.var_674.assign(new Vector3d());
         }
         this.var_560 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_331.length)
         {
            _loc2_ = this.var_331[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_331.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_331[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_331[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.width == param2 && this.var_29.height == param3 && Vector3d.isEqual(this.var_674,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_560,param6,param7);
                     return param1;
                  }
                  return this.var_29;
               }
         ...
         {
            if(this.var_29.width == param2 && this.var_29.height == param3)
            {
               this.var_29.fillRect(this.var_29.rect,16777215);
            }
            else
            {
               this.var_29.dispose();
         ...
         this.var_1567 = true;
         this.var_674.assign(param4);
         if(!param5)
         {
            this.var_560 = param3;
            if(this.var_29 == null)
            {
               this.var_29 = new BitmapData(param2,param3,true,4294967295);
            }
            else
            {
         ...
         {
            this.var_560 = param3;
            this.var_29 = new BitmapData(param2,param3,true,16777215);
         }
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_331.length)
         {
            _loc11_ = this.var_331[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
         ...
         {
            case const_215:
               _loc10_ = this.renderRepeatBorders(this.var_29,_loc8_);
               break;
            case const_236:
               _loc10_ = this.renderRepeatCenter(this.var_29,_loc8_);
               break;
            case const_233:
               _loc10_ = this.renderRepeatFirst(this.var_29,_loc8_);
               break;
            case const_252:
               _loc10_ = this.renderRepeatLast(this.var_29,_loc8_);
               break;
            case REPEAT_MODE_RANDOM:
               _loc10_ = this.renderRepeatRandom(this.var_29,_loc8_);
               break;
            default:
               _loc10_ = this.renderRepeatAll(this.var_29,_loc8_);
         }
         this.var_560 = _loc10_;
         if(param1 != null)
         {
      ...
      {
         if(param1 == null || this.var_29 == null || param1 == this.var_29)
         {
            return;
         }
         if(!param4)
         ...
         var _loc5_:* = null;
         if(this.var_1583 == const_118)
         {
            _loc5_ = new Rectangle(0,0,this.var_29.width,this.var_560);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_29.height - this.var_560,this.var_29.width,this.var_560);
         }
         param1.copyPixels(this.var_29,_loc5_,new Point(0,param3),null,null,true);
      }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_331.length == 1)
         {
            _loc4_ = this.var_331[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
