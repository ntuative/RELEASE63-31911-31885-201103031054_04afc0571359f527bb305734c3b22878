package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_98:int = 3;
      ...
      private var var_917:IPlaneRasterizer = null;
      
      private var var_773:PlaneMaskManager = null;
      ...
      private var var_416:PlaneBitmapData = null;
      ...
      private var var_212:BitmapData = null;
      ...
      private var var_736:Boolean = true;
      ...
      {
         return this._isVisible && this.var_736;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_194 != null)
         {
            ...
            {
               _loc2_ = this.var_194.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_194.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_194 != null)
         {
            ...
            {
               _loc3_ = this.var_194.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_917.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_416;
         if(_loc3_ == null)
         {
            _loc4_ = this.getTextureIdentifier(param1.scale);
            _loc3_ = this.var_194.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_736 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_352))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_917 != null)
            {
               _loc3_ = this.var_917.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1734,this.var_2406,this.var_2404,this.var_2408,this.var_2403,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1904 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_736)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1394.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1394[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1122);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_150.z - originZ,this.var_110.z - originZ,this.var_86.z - originZ,this.var_109.z - originZ);
            if(this._type == const_98)
            {
               relativeDepth += 0.02;
            }
            this.var_2407 = relativeDepth;
            this._isVisible = true;
            this.var_1904 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2405);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_121 || this._type == const_98)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_121 || this._type == const_98))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_918)
         {
            ...
            {
               _loc4_ = this.var_249[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_918)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_351.length)
            {
               _loc5_ = this.var_351[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_249.length == this.var_919.length)
         {
            while(_loc1_ < this.var_249.length)
            {
               _loc4_ = this.var_249[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_919.length)
                  {
                     _loc7_ = this.var_919[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_351.length > this.var_1395.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_918 || this.var_249.length == 0 && this.var_351.length == 0 && !this.var_352 || this.var_773 == null)
         {
            return;
         }
         ...
         if(this.var_352)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_600);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_249.length)
            {
               _loc3_ = this.var_249[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc3_.leftSideLoc / this.var_310.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc3_.rightSideLoc / this.var_309.length;
                  _loc12_ = _loc3_.type;
                  this.var_773.updateMask(this.var_68,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_919.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_351.length)
            {
               _loc4_ = this.var_351[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc4_.leftSideLoc / this.var_310.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc4_.rightSideLoc / this.var_309.length;
                  _loc13_ = this.var_68.width * _loc4_.leftSideLength / this.var_310.length;
                  _loc14_ = this.var_68.height * _loc4_.rightSideLength / this.var_309.length;
                  this.var_68.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1395.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_352 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_212 != null && (this.var_212.width != param1.width || this.var_212.height != param1.height))
         {
            this.var_212.dispose();
            this.var_212 = null;
         }
         if(this.var_212 == null)
         {
            this.var_212 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_212.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_212.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_212,this.var_212.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
