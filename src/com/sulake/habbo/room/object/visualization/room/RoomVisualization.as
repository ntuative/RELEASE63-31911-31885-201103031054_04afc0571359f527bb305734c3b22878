package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1418:int = 16777215;
      
      public static const const_1607:int = 13421772;
      
      private static const const_938:int = 16777215;
      
      private static const const_939:int = 13421772;
      
      private static const const_937:int = 10066329;
      
      private static const const_940:int = 10066329;
      
      public static const const_1419:int = 16777215;
      
      public static const const_1581:int = 13421772;
      ...
      private var var_717:Rectangle = null;
      
      private var var_480:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2292:String = null;
      
      private var var_1079:uint = 16777215;
      
      private var var_2290:int = 255;
      
      private var var_2291:int = 255;
      
      private var include:int = 255;
      
      private var var_1661:Boolean = true;
      
      private var var_1662:int = 0;
      
      private var _lastUpdateTime:int = -1000;
      
      private const const_1978:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_480 = new RoomPlaneBitmapMaskParser();
         this.var_285["null"] = false;
         this.var_285["null"] = true;
         this.var_285["null"] = true;
         this.var_285["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_128.length)
            {
               _loc4_ = this.var_128[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_717 = super.boundingRectangle;
         }
         return new Rectangle(this.var_717.x,this.var_717.y,this.var_717.width,this.var_717.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_128.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_128[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1120);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1001);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_163)
            {
               ...
               {
                  _loc13_.color = const_938;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_939;
               }
               else
               {
                  _loc13_.color = const_937;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_320)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_98,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1484)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_121,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_320)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1978 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_343.length)
            {
               _loc10_ = this.var_585[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_343[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_98)
               {
                  if(this.var_1661)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.include / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2291 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2290 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1904)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1471 || _loc3_.y != this.var_2293 || _loc3_.z != this.var_2287 || param1.scale != this.var_2288))
            {
               this.var_1471 = _loc3_.x;
               this.var_2293 = _loc3_.y;
               this.var_2287 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_164 != param1.getUpdateID())
         {
            ...
            if(_loc3_ != this.var_2292)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2292 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_693));
            if(_loc4_ != this.var_1079)
            {
               this.var_1079 = _loc4_;
               this.include = this.var_1079 & 255;
               this.var_2291 = this.var_1079 >> 8 & 255;
               this.var_2290 = this.var_1079 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1033));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_164 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_877);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_637);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_674);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_713));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_774));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         {
            _loc5_ = this.var_128[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_204 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               ...
               else if(_loc5_.type == RoomPlane.const_98 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
      ...
      {
         if(param1 != this.var_285["null"] || param2 != this.var_285["null"] || param3 != this.var_285["null"])
         {
            this.var_285["null"] = param1;
            this.var_285["null"] = param2;
            this.var_285["null"] = param3;
            this.var_343 = [];
            this.var_585 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_343;
         if(this.var_343.length == 0)
         {
            _loc6_ = this.var_128;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_343.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_204)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_285[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_343.push(_loc12_);
                        this.var_585.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1662;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_480.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         {
            _loc3_ = this.var_128[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
               _loc3_.resetBitmapMasks();
               if(_loc3_.type == RoomPlane.const_98)
               {
                  _loc4_.push(_loc7_);
               }
            }
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_480.maskCount)
         {
            _loc10_ = this.var_480.getMaskType(_loc8_);
            _loc11_ = this.var_480.getMaskLocation(_loc8_);
            _loc12_ = this.var_480.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_128.length)
               {
                  _loc3_ = this.var_128[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_121 || _loc3_.type == RoomPlane.const_98)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_121 || _loc3_.type == RoomPlane.const_98 && _loc12_ == RoomPlaneBitmapMaskData.const_264)
                              {
                                 _loc3_.addBitmapMask(_loc10_,_loc16_,_loc17_);
                              }
                              else if(_loc3_.type == RoomPlane.const_98)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_128[_loc18_] as RoomPlane;
