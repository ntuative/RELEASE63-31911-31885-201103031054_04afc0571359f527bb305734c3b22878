package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_29:BitmapData = null;
      
      private var var_568:PlaneTexture;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_568 != null)
         {
            _loc2_ = this.var_568.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_568 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  if(this.var_29 != null)
                  {
                     if(this.var_29.width != _loc2_.width || this.var_29.height != _loc2_.height)
                     {
                        this.var_29.dispose();
                        this.var_29 = null;
                     }
                     ...
                     {
                        this.var_29.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(this.var_29 == null)
                  {
                     this.var_29 = _loc2_.clone();
                  }
                  _loc3_ = Math.min(this.var_1051,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_1051,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_1051,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_868[_loc6_ % this.var_868.length] as IGraphicAsset;
                     if(_loc7_ != null && _loc8_ != null)
                     {
                        ...
                        if(_loc9_ != null)
                        {
                           ...
                           if(_loc10_ != null)
                           {
                              ...
                              this.var_29.draw(_loc10_,_loc12_);
                           }
                        }
                     }
                     _loc6_++;
