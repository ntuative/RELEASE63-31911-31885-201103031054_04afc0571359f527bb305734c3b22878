package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class AnimationItem
   {
      ...
      private var var_153:Number = 0.0;
      
      private var var_1376:Number = 0.0;
      
      private var var_1377:Number = 0.0;
      ...
      public function AnimationItem(param1:Number, param2:Number, param3:Number, param4:Number, param5:BitmapData)
      {
         ...
         if(isNaN(this.var_153))
         {
            this.var_153 = 0;
         }
         if(isNaN(this.var_1376))
         {
            this.var_1376 = 0;
         }
         if(isNaN(this.var_1377))
         {
            this.var_1377 = 0;
         }
      ...
      public function getPosition(param1:int, param2:int, param3:Number, param4:Number, param5:int) : Point
      {
         ...
         var _loc7_:Number = this.var_153;
         if(param3 > 0)
         {
            _loc6_ += this.var_1376 / param3 * param5 / 1000;
         }
         if(param4 > 0)
         {
            _loc7_ += this.var_1377 / param4 * param5 / 1000;
         }
