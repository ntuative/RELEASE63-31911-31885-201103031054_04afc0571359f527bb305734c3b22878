package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1606:String = "cone";
      
      public static const const_1603:String = "plane";
      
      public static const const_1655:String = "sphere";
      ...
      private var var_966:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_967 = 0;
         this.var_880 = false;
         this.init(0,0,0,this._direction,this.var_2591,this.var_966,this.var_2592,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1177.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_880 = true;
         if(this.var_967 < this.var_1445)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2593)
         {
            switch(this.var_2594)
            {
               case const_1606:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_966,_loc6_,_loc7_,_loc9_,_loc8_);
            this.var_365.push(_loc4_);
            ++this.var_967;
            _loc10_++;
         }
      }
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1177.length);
         return this.var_1177[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_967 < this.var_1445)
         {
            if(this.age % this.var_2595 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_967 < this.var_1445)
         {
            ...
            this.y = (2 - this.var_259) * this.y - (1 - this.var_259) * this.lastY + this.var_1857 * this.var_966 * this.var_966;
         ...
         for each(_loc2_ in this.var_365)
         {
            ...
            _loc2_.y = (2 - this.var_259) * _loc2_.y - (1 - this.var_259) * _loc2_.lastY + this.var_1857 * this.var_966 * this.var_966;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_365.splice(this.var_365.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
