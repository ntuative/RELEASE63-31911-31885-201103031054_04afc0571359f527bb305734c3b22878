package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1357:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1193)
            {
      ...
      {
         if(param1 == 1 || param2 != this.method_7(param1))
         {
      ...
      private function method_7(param1:int) : int
      {
         if(this.var_2651 == param1 && this.var_2652 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1357)
            {
               this.var_1897 = _loc2_;
               this.var_2651 = param1;
               this.var_2652 = _direction;
               return this.var_1897;
            }
            _loc2_--;
         }
      ...
      {
         var _loc2_:String = super.getSpriteAssetName(param1,this.method_7(param1));
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1193.indexOf(_loc2_) < 0)
            {
               this.var_1193.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_632[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_632[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_516 == 0 || this.var_631 == 0)
         {
            ...
            this.var_516 = _loc2_.getNumber(RoomObjectVariableEnum.const_294);
            this.var_631 = _loc2_.getNumber(RoomObjectVariableEnum.const_390);
         }
         this.var_430 = [];
         this.var_632 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_516 * 2 + this.var_631 * 2)
         {
            this.var_430.push(false);
            this.var_632.push(ShoreMaskCreatorUtility.const_76);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_68,getSize(param3),this.var_430,this.var_632,assetCollection);
      }
