package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      public static const const_143:int = 0;
      
      public static const const_76:int = 1;
      
      public static const const_63:int = 2;
      ...
      {
         return param1 + param2 * const_1342;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_143,const_76,const_63,const_143,const_76,const_63];
                     _loc8_ = [const_76,const_76,const_76,const_63,const_63,const_63];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
