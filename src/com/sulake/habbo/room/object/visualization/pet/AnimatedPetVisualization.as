package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_605:int = 1;
      
      private static const const_953:int = 1000;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_348);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_267);
            this.validateActions(_loc4_,_loc5_);
            this._isSleeping = _loc3_.getNumber(RoomObjectVariableEnum.const_339) > 0;
            this.var_1528 = _loc3_.getNumber(RoomObjectVariableEnum.const_306);
            this.var_1397 = _loc3_.getNumber(RoomObjectVariableEnum.const_813);
            this.var_2411 = _loc3_.getNumber(RoomObjectVariableEnum.const_690);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.PET_PALETTE_INDEX);
            if(_loc6_ != this.var_1796)
            {
               this.var_1796 = _loc6_;
               this.var_2496 = this.var_1796.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this._experienceData != null)
         {
            ...
            if(this.var_1397 > 0)
            {
               _loc2_ = param1 - this.var_1397;
               if(_loc2_ < const_953)
               {
                  this._experienceData.alpha = int(Math.sin(_loc2_ / const_953 * 0) * 255);
      ...
      {
         var _loc3_:int = 0;
         if(param1 != this.var_227)
         {
            this.var_227 = param1;
            _loc3_ = this.var_303.getAnimationForPosture(var_183,param1);
            this.setAnimationForIndex(const_1338,_loc3_);
         }
         if(param2 != this.var_1263)
         {
            this.var_1263 = param2;
            _loc3_ = this.var_303.getAnimationForGesture(var_183,param2);
            this.setAnimationForIndex(const_1336,_loc3_);
         }
      }
      
      override protected function getAdditionalSpriteCount() : int
      {
         return super.getAdditionalSpriteCount() + const_605;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            _loc2_ = assetCollection.getAssetWithPalette(param1,this.var_2496);
            if(_loc2_ == null)
            {
            }
            return _loc2_;
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_605)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_605))
            {
               if(_data == null || param2 >= FurnitureVisualizationData.const_539.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_539[param2];
               if(_loc4_ == 1)
               {
