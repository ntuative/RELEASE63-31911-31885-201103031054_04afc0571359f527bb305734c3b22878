   ...
   public class SizeData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_251 != null)
         {
            _loc2_ = null;
            _loc1_ = 0;
            while(_loc1_ < this.var_251.length)
            {
               _loc2_ = this.var_251.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_251.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            this.var_251.add(String(_loc7_),_loc3_);
            this.var_1754 = -1;
            this.var_1132 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_1004);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1090);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1403 / 2) % 360 / this.var_1403;
         if(this.var_251.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_251.length)
         {
            _loc6_ = int(this.var_251.getKey(_loc5_)) * this.var_1403;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_251.getKey(_loc4_));
         }
         return const_1658;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_251.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_740;
         }
