package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1505:int = 255;
      
      private var var_1250:uint = 16777215;
      
      private var var_1506:int = 255;
      
      private var var_1005:uint = 16777215;
      
      private var var_1504:int = 255;
      
      private var var_1006:int = 0;
      
      private var var_1507:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1120,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_693,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_713,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_774,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_844,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1006)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1505;
            if(_loc2_ - this.var_1006 >= this.var_1507)
            {
               _loc3_ = this.var_1005;
               _loc4_ = this.var_1504;
               this.var_1006 = 0;
            }
            else
            {
               _loc7_ = this.var_1250 >> 16 & 255;
               _loc8_ = this.var_1250 >> 8 & 255;
               _loc9_ = this.var_1250 & 255;
               _loc10_ = this.var_1005 >> 16 & 255;
               _loc11_ = this.var_1005 >> 8 & 255;
               _loc12_ = this.var_1005 & 255;
               _loc13_ = (_loc2_ - this.var_1006) / this.var_1507;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1506 + (this.var_1504 - this.var_1506) * _loc13_;
               this._color = _loc3_;
               this.var_1505 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_693,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_648:
               param2.setString(RoomObjectVariableEnum.const_637,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_884:
               param2.setString(RoomObjectVariableEnum.const_877,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_701:
               param2.setString(RoomObjectVariableEnum.const_674,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_484:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_264)
               {
                  _loc5_ = "null";
               }
               this.var_480.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_883:
               _loc4_ = this.var_480.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_480.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_981,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1038:
               param2.setNumber(RoomObjectVariableEnum.const_713,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1113:
               param2.setNumber(RoomObjectVariableEnum.const_774,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_844,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1033,int(param1.bgOnly));
         this.var_1250 = this._color;
         this.var_1506 = this.var_1505;
         this.var_1005 = _loc3_;
         this.var_1504 = _loc4_;
         this.var_1006 = getTimer();
         this.var_1507 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_532,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1449,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1568,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1471,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_532,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_176)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_163 || _loc13_ == RoomPlaneData.const_320)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
