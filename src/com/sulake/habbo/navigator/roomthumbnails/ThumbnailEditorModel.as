package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailEditorModel
   {
      ...
      private var var_636:int = 1;
      
      private var var_197:RoomThumbnailObjectData;
      ...
      private function removeSelected() : void
      {
         ...
         var _loc2_:int = Util.remove(_loc1_,this.var_197);
         this.var_197 = null;
         if(_loc1_.length > 0)
         {
            this.var_197 = _loc1_[Math.min(_loc2_,_loc1_.length - 1)];
         }
      }
      ...
      {
         this.var_197 = this.findByPos(param1);
         if(this.var_197 == null)
         {
      ...
      {
         if(this.var_636 == const_35)
         {
            this._data.bgImgId = param1;
         }
         else if(this.var_636 == const_58)
         {
            this._data.frontImgId = param1;
         }
         if(this.var_636 == const_33)
         {
            if(this.var_197 == null)
            {
               return;
            }
            this.var_197.imgId = param1;
         }
      }
      ...
      public function getImgId() : int
      {
         ...
         if(this.var_636 == const_58)
         {
            return this._data.frontImgId;
         }
         return this.var_197 == null ? -1 : int(this.var_197.imgId);
      }
      ...
      {
         this._data = param1;
         this.var_636 = const_35;
         if(this._data.objects.length > 0)
         {
            this.var_197 = this._data.objects[0];
         }
         else
         {
            this.var_197 = null;
