package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1647 = this._navigator.getButtonImage(this.var_1644);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1645 == null)
         {
            ...
            this.var_1645 = new Rectangle(this.var_1329,this.var_1329,_loc1_.width - 2 * this.var_1329,_loc1_.height - 2 * this.var_1329);
         }
         this.var_582.bitmap.fillRect(this.var_582.bitmap.rect,4281545523);
         this.var_582.bitmap.fillRect(this.var_1645,4284900966);
         this.copyTo(this.var_582.bitmap);
         if(this.var_197)
         {
            this.var_582.bitmap.copyPixels(this.var_1646,this.var_1646.rect,new Point(0,0),null,null,true);
         }
