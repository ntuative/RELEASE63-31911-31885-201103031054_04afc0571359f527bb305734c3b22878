package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_533:int = 10;
      
      private static const const_905:int = 32;
      
      private static const const_1225:int = 8;
      
      private static const const_1227:int = -16;
      
      private static const const_1226:int = 40;
      ...
      private var var_813:ThumbnailImageConfigurations;
      
      private var _order:Dictionary;
      
      private var var_1259:BitmapData;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_813 = new ThumbnailImageConfigurations(this._navigator);
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2022 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_905 / 2);
         return new Point(param1 * const_905 + _loc3_,param2 * const_1225);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_327,HabboWindowStyle.const_41,0 | (!!param3 ? HabboWindowParam.const_38 : HabboWindowParam.const_41),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_813.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_813.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_813.getImage(ThumbnailEditorModel.const_58,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1259 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1259,this.var_1259.rect,new Point(0,0),null,null,true);
      }
      
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_813.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1227,_loc4_.y + const_1226 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2022[param1]);
      }
   }
}
