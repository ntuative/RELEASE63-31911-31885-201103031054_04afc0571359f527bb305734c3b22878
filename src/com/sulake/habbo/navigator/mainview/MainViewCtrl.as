package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_611:int = 2;
      ...
      private var var_983:PopularTagsListCtrl;
      
      private var var_984:GuestRoomListCtrl;
      
      private var var_1215:OfficialRoomListCtrl;
      ...
      private var var_1214:Boolean = true;
      
      private var var_1480:int = 0;
      
      private var var_1479:IWindow;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_983 = new PopularTagsListCtrl(this._navigator);
         this.var_984 = new GuestRoomListCtrl(this._navigator);
         this.var_1215 = new OfficialRoomListCtrl(this._navigator);
         this.var_466 = new Timer(300,1);
      ...
      private function prepare() : void
      {
         ...
         this.var_223 = IWindowContainer(this.var_16.findChildByName("custom_content"));
         this.var_198 = IWindowContainer(this.var_16.findChildByName("list_content"));
         this.var_263 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1479 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1213 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1213)
         {
         ...
         {
            _loc3_ = this.var_264.method_13(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_643,false);
      ...
      public function refresh() : void
      {
         ...
         this.var_263.height = Util.getLowestPoint(this.var_263);
         var _loc1_:int = this.var_198.y;
         Util.moveChildrenToColumn(this.var_178,["custom_content","list_content"],this.var_223.y,8);
         this.var_198.height = this.var_198.height + _loc1_ - this.var_198.y - this.var_263.height + this.var_2714;
         Util.moveChildrenToColumn(this.var_178,["list_content","custom_footer"],this.var_198.y,0);
         this.var_2714 = this.var_263.height;
      ...
      {
         Util.hideChildren(this.var_263);
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(this.var_263);
         if(Util.hasVisibleChildren(this.var_263))
         {
            this.var_263.visible = true;
         }
         else
         {
      ...
      {
         this.refreshList(param1,param2,this.var_984,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_983,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1215,"official_rooms");
      }
      ...
      {
         if(param1 == Tabs.const_878)
         {
            return new MyFavouriteRoomsSearchMessageComposer();
         }
         if(param1 == Tabs.const_724)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_639 == const_973)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_198.blend - _loc2_));
            this.var_198.blend = _loc3_;
            this.var_223.blend = !!this.var_1214 ? Number(_loc3_) : Number(1);
            this.var_263.blend = !!this.var_1214 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_639 = const_611;
            }
         }
         else if(this.var_639 == const_611)
         {
            if(this.var_1480 % 10 == 1)
            {
               this.var_1479.visible = !this.var_1479.visible;
            }
            ++this.var_1480;
            if(!this._navigator.data.isLoading())
            {
               this.var_639 = const_972;
            }
         }
         else if(this.var_639 == const_972)
         {
            this.refresh();
            this.var_639 = const_1367;
         }
         else
         {
