package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1356:int = 267;
      
      private static const const_1354:int = 65;
      
      private static const const_1355:int = -70;
      ...
      private var var_2650:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2650 = new PublicRoomThumbs();
         super();
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1458)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_856 || param2.type == OfficialRoomEntryData.const_664))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1354) : int(const_1356);
      ...
      {
         var _loc4_:String = this.var_2650.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1355) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         if(_loc2_.guestRoomData != null)
         {
            ...
            if(_loc2_.guestRoomData.doorMode == RoomSettingsFlatInfo.const_119)
            {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_229,Tabs.const_354,_loc2_.tag);
         }
