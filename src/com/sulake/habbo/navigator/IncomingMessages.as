package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.securityLevel >= SecurityLevelEnum.const_1166)
            {
               this._navigator.data.eventMod = true;
            }
            if(_loc2_.securityLevel >= SecurityLevelEnum.const_1515)
            {
         ...
         {
            _loc3_ = UserRightsMessageEvent(param1).rights;
            Logger.log("GOT USER RIGHTS: " + _loc3_.length);
            for each(_loc4_ in _loc3_)
            {
               if(_loc4_ == "fuse_cancel_roomevent")
               {
                  Logger.log("User can cancel room events");
                  this._navigator.data.eventMod = true;
               }
               if(_loc4_ == "select_staff_picked_rooms_in_client")
               {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.ROOMINFO));
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_193 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
               this._navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_119 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_99,HabboToolbarIconEnum.EXITROOM);
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_138,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_263);
      }
