package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_290:MainViewCtrl;
      
      private var var_598:RoomInfoViewCtrl;
      
      private var var_1117:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_426:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2824:Dictionary;
      ...
      private var var_2398:RoomThumbnailRenderer;
      
      private var var_962:GuestRoomPasswordInput;
      
      private var var_311:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_290 = new MainViewCtrl(this);
         this.var_598 = new RoomInfoViewCtrl(this);
         this.var_1117 = new RoomCreateViewCtrl(this);
         this.var_2398 = new RoomThumbnailRenderer(this);
         this.var_962 = new GuestRoomPasswordInput(this);
         this.var_311 = new GuestRoomDoorbell(this);
         this.var_426 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_327,HabboWindowStyle.const_41,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_598.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_168.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_290.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_290.startSearch(Tabs.const_229,Tabs.const_354,param1);
         this.var_290.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_290.startSearch(Tabs.const_313,Tabs.const_263);
         this.var_426.getTab(Tabs.const_313).tabPageDecorator.tabSelected();
      }
