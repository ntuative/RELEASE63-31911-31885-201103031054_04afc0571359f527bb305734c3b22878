package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1150:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_610 = new Timer(100);
         this.var_610.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_43 = new Array();
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,104,"a"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,94,"b"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,36,"c"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,84,"d"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,80,"e"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,80,"f"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,416,"i"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,320,"j"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,448,"k"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,352,"l"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,384,"m"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_54,372,"n"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_40,80,"g"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_40,74,"h"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_40,416,"o"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_40,352,"p"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_40,304,"q"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_40,336,"r"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_40,748,"u"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_40,438,"v"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_43,540,"t"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_43,512,"w"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_43,396,"x"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_43,440,"y"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_43,456,"z"));
         this.var_43.push(new RoomLayout(HabboClubLevelEnum.const_43,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_610)
         {
            this.var_610.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_610.reset();
            this.var_610 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1150.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1802 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1802 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_59 = IItemListWindow(this.var_178.findChildByName("item_list"));
         ...
         this.var_1149 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_178.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1149.goBackToInitialState();
         this.var_1149.input.textBackgroundColor = 4294967295;
         this.var_1150 = this.var_43[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         while(this.var_59.numListItems > 0)
         {
            _loc6_ = this.var_59.removeListItemAt(0);
            _loc6_.destroy();
         }
         for each(_loc1_ in this.var_43)
         {
         ...
         while(_loc4_ < this.var_43.length)
         {
            ...
            if(this.isAllowed(_loc7_))
            {
               ...
               {
                  _loc3_ = this.getRow();
                  this.var_59.addListItem(_loc3_);
               }
         ...
         if(this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_40))
         {
         ...
         if(_loc5_)
         {
            ...
            if(_loc8_)
            {
               ...
               this.var_59.addListItem(_loc8_);
            }
         }
      }
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_54:
               return true;
            case HabboClubLevelEnum.const_40:
               return this._navigator.sessionData.hasUserRight("fuse_use_special_room_layouts",HabboClubLevelEnum.const_40);
            case HabboClubLevelEnum.const_43:
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_61,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1149.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1149.getText();
         var _loc3_:String = "model_" + this.var_1150.name;
