package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_518:Quest;
      
      private var var_307:QuestView;
      ...
      public function QuestCampaign(param1:QuestController, param2:String)
      {
         ...
         this.var_181 = new QuestHelp(this);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1201 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1467 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_306 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.code + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1467.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1467.findChildByName("currency.amount").caption = "${quest_" + this.var_1910 + ".currency}";
         var _loc3_:String = "quest_" + this.code;
         var _loc4_:* = _loc3_ + ".title";
         var _loc5_:* = _loc3_ + ".currency";
         this.setText("currency.amount",_loc5_);
         this.var_1202 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1202)
         {
            this.var_1202.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1202.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1202.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_518)
         {
            this.var_518.selected = false;
         }
         if(this.var_181)
         {
            this.var_1201.addChild(this.var_181.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1503);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1467.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         for each(_loc4_ in this.var_370)
         {
            ...
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_46 || _loc4_.status == QuestStatusEnum.const_441))
            {
               _loc3_ = _loc4_;
            }
         }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_518 = param1;
         this.var_518.selected = true;
         this.showQuestData(this.var_518);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_307 = new QuestView(this,param1);
         this.var_1201.addChild(this.var_307.view);
         this.var_307.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_780.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_780)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_780.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_780.splice(_loc4_,1);
            }
         }
      }
