package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_93:Quest;
      
      private var _view:IWindow;
      
      private var var_1517:int;
      
      private var var_1516:IScrollableListWindow;
      ...
      {
         switch(this.var_93.type)
         {
            case QuestTypeEnum.FIND_STUFF:
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               this._view = this.var_62.controller.questEngine.getXmlWindow("QuestTypeFindStuff");
               this.var_1516 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
            case QuestTypeEnum.GIVE_BADGE:
               this._view = this.var_62.controller.questEngine.getXmlWindow("QuestTypeGiveBadge");
               this.var_1516 = this.find("quest.content.itemlist") as IScrollableListWindow;
               break;
            default:
               throw new Error("[QuestView] View not defined for quest type: " + this.var_93.type + " !");
         }
         if(!this._view)
         {
            throw new Error("[QuestView] Could not create view for quest type: " + this.var_93.type + " !");
         }
      }
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_93)
         {
            this.var_62.controller.activateQuest(this.var_93);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc37_:* = null;
         var _loc38_:* = null;
         var _loc1_:String = ["quest",this.var_62.code,this.var_93.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_62.code,"type_" + this.var_93.type.toLowerCase()].join(".");
         ...
         if(this.var_93.type == QuestTypeEnum.FIND_STUFF)
         {
            _loc33_ = this.var_93.roomItemTypeName.split("*");
            _loc34_ = _loc33_.length > 0 ? _loc33_[0] : "";
            _loc35_ = _loc33_.length > 1 ? int(parseInt(_loc33_[1])) : 0;
            _loc36_ = this.var_62.controller.questEngine.sessionDataManager.getFloorItemDataByName(_loc34_,_loc35_);
            if(_loc36_)
            {
               _loc38_ = "";
               _loc37_ = this.var_62.controller.questEngine.roomEngine.getFurnitureImage(_loc36_.id,new Vector3d(90,0,0),64,this,_loc35_,_loc38_);
               this.var_1517 = _loc37_.id;
               if(_loc37_ && _loc37_.data)
               {
                  this.imageReady(_loc37_.id,_loc37_.data);
               }
               this.var_62.controller.questEngine.localization.registerParameter(_loc7_,"name",_loc36_.title);
            }
         }
         else if(this.var_93.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
            this.var_62.controller.questEngine.setImageFromAsset(_loc15_,"icon_quest_hidden",this.onPreviewImageReady);
         }
         else if(this.var_93.type == QuestTypeEnum.GIVE_BADGE)
         {
            this.var_62.controller.questEngine.setImageFromAsset(_loc15_,this.var_93.questBadgeAchievementTypeId,this.onPreviewImageReady);
         }
         else
         {
            this.var_1517 = -1;
         ...
         switch(this.var_93.status)
         {
            case QuestStatusEnum.const_441:
            ...
            case QuestStatusEnum.const_200:
               ...
               _loc19_ = 4290822336;
               break;
            case QuestStatusEnum.const_746:
         ...
         this.var_62.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_93.rewardCurrencyAmount.toString());
         this.setText("quest.reward.title",_loc13_);
         this.setText("quest.reward.desc",_loc14_);
         var _loc20_:int = this.var_93.endDate.date;
         var _loc21_:int = this.var_93.endDate.month + 1;
         var _loc22_:int = this.var_93.endDate.fullYear;
         var _loc23_:int = this.var_93.endDate.minutes;
         var _loc24_:int = this.var_93.endDate.hours;
         var _loc25_:int = _loc24_ > 11 ? int(_loc24_ - 12) : int(_loc24_);
         var _loc26_:String = _loc24_ < 12 ? "am" : "pm";
         this.var_62.controller.questEngine.localization.registerParameter("quest.available","day",_loc20_.toString());
         this.var_62.controller.questEngine.localization.registerParameter("quest.available","month",_loc21_.toString());
         this.var_62.controller.questEngine.localization.registerParameter("quest.available","year",_loc22_.toString());
         this.var_62.controller.questEngine.localization.registerParameter("quest.available","12h",this.pad(_loc25_));
         this.var_62.controller.questEngine.localization.registerParameter("quest.available","24h",this.pad(_loc24_));
         this.var_62.controller.questEngine.localization.registerParameter("quest.available","ampm",_loc26_);
         this.var_62.controller.questEngine.localization.registerParameter("quest.available","minute",this.pad(_loc23_));
         ...
         var _loc30_:String = "header_" + this.var_62.code;
         this.var_62.controller.questEngine.setImageFromAsset(_loc29_,_loc30_,this.onHeaderImageReady);
         var _loc31_:IBitmapWrapperWindow = this.find("quest.reward.icon") as IBitmapWrapperWindow;
         var _loc32_:String = "icon_" + this.var_62.code + "_reward_" + this.var_93.rewardCurrencyAmount;
         this.var_62.controller.questEngine.setImageFromAsset(_loc31_,_loc32_,this.onRewardImageReady);
         this.updateMargins();
      }
      ...
      private function onRewardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_62.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onRewardImageReady);
         }
      }
      ...
      private function onHeaderImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_62.controller.questEngine.setImageFromAsset(_loc3_,_loc2_.assetName,this.onHeaderImageReady);
         }
      }
