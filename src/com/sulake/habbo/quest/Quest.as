package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_2085:uint = 2;
      
      private var var_2084:uint = 0;
      
      private var var_815:IWindow;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1499 = param1.roomItemTypeName;
         this.var_1498 = param1.rewardCurrencyAmount;
         this.var_1558 = new Date();
         this.var_1558.setTime(param1.endDateTimeStamp);
         this.var_652 = param1.localizationCode;
      ...
      private function updateView() : void
      {
         ...
         var _loc3_:String = ["quest",this.var_62.code,this.var_652].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_197)
            {
               this.var_815.style = this.var_2084;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_197)
            {
               this.var_815.style = this.var_2085;
            }
         }
      }
