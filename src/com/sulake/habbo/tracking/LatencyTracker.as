package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         if(this.var_168 == null || this._communication == null || this._connection == null)
         {
            return;
         }
         this.var_1839 = int(this.var_168.getKey("latencytest.interval"));
         this.var_1840 = int(this.var_168.getKey("latencytest.report.index"));
         this.var_2570 = int(this.var_168.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1837 > this.var_1839)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_618.add(this.var_1439,this.var_1837);
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_618 == null || this.var_220 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_618.getValue(_loc2_.requestId);
         this.var_618.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_220.push(_loc4_);
         if(this.var_220.length == this.var_1840 && this.var_1840 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1838) > this.var_2570 || this.var_1838 == 0)
            {
               this.var_1838 = _loc9_;
