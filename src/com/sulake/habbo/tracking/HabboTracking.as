package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_929:uint = 11;
      ...
      private var var_187:IHabboFriendList;
      
      private var var_1048:IHabboWindowManager;
      
      private var var_179:IHabboToolbar;
      
      private var var_181:IHabboHelp;
      ...
      private var var_567:FramerateTracker = null;
      
      private var var_232:LatencyTracker = null;
      
      private var var_565:LagWarningLogger = null;
      
      private var var_566:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_231 = new PerformanceTracker();
         this.var_567 = new FramerateTracker();
         this.var_232 = new LatencyTracker();
         this.var_565 = new LagWarningLogger();
         this.var_566 = new ToolbarClickTracker(this);
         this.var_1307 = new Array(const_929);
         var _loc4_:int = 0;
         while(_loc4_ < const_929)
         {
            this.var_1307[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1617,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1473,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_782,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1161,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1048)
            {
               this.var_1048.release(new IIDHabboWindowManager());
               this.var_1048 = null;
            }
            if(this.var_286)
            {
            ...
            if(this.var_187)
            {
               ...
               {
                  Component(this.var_187).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_187).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_187).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_187).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_187).events.removeEventListener(HabboFriendListTrackingEvent.const_407,this.onFriendlistTrackingEvent);
               }
               this.var_187.release(new IIDHabboFriendList());
               this.var_187 = null;
            }
            if(this.var_181)
            {
               if(!this.var_181.disposed)
               {
                  this.var_181.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_181.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_181.release(new IIDHabboHelp());
               this.var_181 = null;
            }
            if(this.var_179)
            {
      ...
      {
         this.var_1307[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_168 = IHabboConfigurationManager(param2);
         if(this.var_168)
         {
            if(this.var_232 != null)
            {
               this.var_232.configuration = this.var_168;
            }
            if(this.var_231 != null)
            {
               this.var_231.configuration = this.var_168;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1481);
            if(this.var_168)
            {
               if(this.var_565 != null)
               {
                  this.var_565.configure(this.var_168);
               }
               if(this.var_567 != null)
               {
                  this.var_567.configure(this.var_168);
               }
               if(this.var_566 != null)
               {
                  this.var_566.configure(this.var_168);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_165);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_771,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_254,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_174,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_173,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_235,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_240,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_750,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_71,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_582,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_231 != null)
            {
               this.var_231.connection = param1;
            }
            if(this.var_232 != null)
            {
               this.var_232.communication = this._communication;
               this.var_232.connection = param1;
            }
            if(this.var_565 != null)
            {
               this.var_565.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_750)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1543);
         }
         else if(param1.type == HabboHotelViewEvent.const_582)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1452);
         }
         else if(param1.type == HabboHotelViewEvent.const_71)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1459);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1643);
               break;
            case HabboCommunicationEvent.const_771:
               this.trackLoginStep(HabboLoginTrackingStep.const_1500,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_254:
               this.trackLoginStep(HabboLoginTrackingStep.const_254);
               break;
            case HabboCommunicationEvent.const_173:
               this.trackLoginStep(HabboLoginTrackingStep.const_173);
               break;
            ...
            case HabboCommunicationEvent.const_240:
               this.trackLoginStep(HabboLoginTrackingStep.const_240);
         }
         if(this._communication)
         {
      ...
      {
         this.var_1048 = IHabboWindowManager(param2);
         if(this.var_1048)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_168)
            {
               if(this.var_168.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_168.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1307)
                  {
                  ...
                  if(this.var_231 != null)
                  {
                     _loc4_["null"] = this.var_231.flashVersion;
                     _loc4_["null"] = this.var_231.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1103);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1103,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_187 = param2 as IHabboFriendList;
         Component(this.var_187).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_187).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_187).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_187).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_187).events.addEventListener(HabboFriendListTrackingEvent.const_407,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_181 = param2 as IHabboHelp;
         this.var_181.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_181.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2181)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1559);
            this.var_2181 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1161,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_322,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_286 = param2 as IAdManager;
         this.var_286.events.addEventListener(AdEvent.const_577,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_566)
         {
            this.var_566.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_168 != null && !Boolean(this.var_168.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_565.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_467 > -1 && _loc2_ < this.var_467)
         {
            ++this.var_1604;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1604);
         }
         if(this.var_467 > -1 && _loc2_ - this.var_467 > 15000)
         {
            ++this.var_1605;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1605);
         }
         this.var_467 = _loc2_;
         if(this.var_231 != null)
         {
            this.var_231.update(param1,this.var_467);
         }
         if(this.var_232 != null)
         {
            this.var_232.update(param1,this.var_467);
         }
         if(this.var_567 != null)
         {
            this.var_567.trackUpdate(param1,this,this.var_467);
         }
         if(this.var_565 != null)
         {
            this.var_565.update(this.var_467);
         }
      }
   }
}
