package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1134:IRoomSession;
      ...
      private const const_1999:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            this.var_15.events.removeEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionEvent.const_97,this.roomSessionEventHandler);
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_431,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_50.getValue(InventoryCategory.const_74));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_50.getValue(InventorySubCategory.const_323));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_50.getValue(InventoryCategory.const_661));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_50.getValue(InventoryCategory.const_356));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_50.getValue(InventoryCategory.const_131));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_50.getValue(InventoryCategory.const_352) as MarketplaceModel;
      }
      ...
      {
         return this.var_100.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_100.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_100.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_100.clubHasEverBeenMember;
      }
      ...
      {
         this.var_100.clubPeriods = param1;
         this.var_100.clubDays = param2;
         this.var_100.clubHasEverBeenMember = param3;
         this.var_100.isVIP = param4;
      ...
      {
         this.var_276 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_89,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionEvent.const_97,this.roomSessionEventHandler);
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_431,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_97:
               this.var_1134 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_431:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_276 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_179)
         {
            return;
         }
         this._view = new InventoryMainView(this,this._windowManager,this._assetLibrary);
         this._view.setToolbar(this.var_179);
         this.var_50 = new Map();
         ...
         this.var_50.add(InventoryCategory.const_352,_loc1_);
         ...
         this.var_50.add(InventoryCategory.const_74,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_276);
         ...
         this.var_50.add(InventoryCategory.const_661,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_276);
         this.var_50.add(InventoryCategory.const_356,_loc5_);
         ...
         this.var_50.add(InventorySubCategory.const_323,_loc6_);
         ...
         this.var_50.add(InventoryCategory.const_131,_loc8_);
         this.var_182 = true;
         if(this.var_2430)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_323:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_926.indexOf(param1) == -1)
            {
               this.var_926.push(param1);
            }
         }
         else
         {
            _loc3_ = this.var_926.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_926.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_926.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1999);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_825));
      }
