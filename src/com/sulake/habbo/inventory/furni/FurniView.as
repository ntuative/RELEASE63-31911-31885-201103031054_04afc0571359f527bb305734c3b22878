package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2015:int = 0;
      
      private const const_935:int = 1;
      
      private const const_1686:int = 2;
      
      private const const_1687:int = 3;
      
      private const const_1717:int = 42;
      
      private const const_1718:int = 120;
      ...
      private var var_784:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_433.add(FurniModel.const_42,new FurniGridView(this.var_65,FurniModel.const_42,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_433.add(FurniModel.const_48,new FurniGridView(this.var_65,FurniModel.const_48,this._windowManager,this._assetLibrary,this._roomEngine));
         ...
         this.switchCategory(FurniModel.const_42);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         var _loc1_:Boolean = this.var_65.isTradingOpen;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_433.getValue(this.var_432);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_65.getCategoryContent(this.var_432);
         if(!this.var_65.isListInited())
         {
            _loc2_ = this.const_935;
         }
         ...
         if(this.var_2081 == _loc2_)
         {
            return;
         }
         this.var_2081 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_42,FurniModel.const_48];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_433.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_433.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_433.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = this.var_65.getSelectedItemIndex();
         _loc4_ = this.var_65.getGroupItemInIndex(_loc3_,this.var_432);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_378)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_336)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_158)
               {
         ...
         var _loc12_:Boolean = this.var_65.isTradingOpen;
         _loc11_ = this._view.findChildByName("placeinroom_btn") as IButtonWindow;
         if(_loc11_)
         {
            if(_loc1_ && this.var_65.isPrivateRoom)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc11_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && this.var_65.canUserOfferToTrade())
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_784 && this.var_784.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1718)
         {
            _loc3_ = this.const_1718;
         }
         else if(_loc3_ < this.const_1717)
         {
            _loc3_ = this.const_1717;
         }
         else
         {
      ...
      {
         var _loc3_:GroupItem = this.var_65.getGroupItemInIndex(this.var_65.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  this.var_65.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  this.var_65.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  this.var_65.requestSelectedFurniSelling();
                  break;
               case "open_catalog_btn":
                  this.var_65.requestCatalogOpen();
                  break;
               default:
         ...
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  this.switchCategory(FurniModel.const_48);
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_405);
            }
         }
      }
   }
