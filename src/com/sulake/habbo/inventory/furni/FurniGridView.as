package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_2829:XML;
      
      private var var_623:Object;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_260 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            this.var_260.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var _loc3_:IWindow = this.var_260.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_260.autoArrangeItems = false;
            this.var_260.lock();
         }
         else
         {
            this.var_260.autoArrangeItems = true;
            this.var_260.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_44)
         {
            ...
            this.var_65.toggleItemSelection(this._category,this.var_260.getGridItemIndex(param1.window));
            this.var_623 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_623 != null && this.var_623 == param2 && !this.var_65.isTradingOpen)
         {
