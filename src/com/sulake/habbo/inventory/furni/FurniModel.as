package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_42:String = "S";
      
      public static const const_48:String = "I";
      
      public static const const_405:String = "pets";
      
      private static const const_1339:int = 100;
      ...
      private var var_1797:Vector.<Array>;
      
      private var var_1798:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_266,this.onObjectPlaced);
         this._catalog = param7;
         this.var_608 = new Timer(const_1339,1);
         this.var_608.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2497 = XML(_loc9_.content);
         this.clearFurniList();
         this._view = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine);
         this._view.switchCategory(const_42);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_266,this.onObjectPlaced);
               }
            ...
            {
               this.var_608.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_608.stop();
               this.var_608 = null;
            }
            if(this.var_195 != null)
            {
               this.var_195.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_195.stop();
               this.var_195 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_42)
            {
               ...
               {
                  this.var_1797 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1797;
            }
            else
            {
               if(this.var_1798 == null)
               {
                  this.var_1798 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1798;
            }
         ...
         this._controller.setInventoryCategoryInit(InventoryCategory.const_74);
         ...
         if(this.getSelectedItemIndex(FurniModel.const_42) == -1)
         {
            this.toggleItemSelection(FurniModel.const_42,0);
         }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_378)
         {
         ...
         if(this.var_948 == null)
         {
            this.var_948 = this._windowManager.buildFromXML(this.var_2497) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_948.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_42,const_48];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_195 = new Timer(param1,1);
            this.var_195.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_195.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_74 && this._controller.isVisible)
         {
      ...
      public function updateItemLocks() : void
      {
         ...
         var _loc7_:Array = [const_42,const_48];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_42,const_48];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_609.add(const_42,new Array());
         this.var_609.add(const_48,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_158)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_323;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_336 || _loc3_.category == FurniCategory.const_378 || _loc3_.category == FurniCategory.const_338)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1420 && param1.type == RoomEngineObjectEvent.const_266)
         {
            this.var_1420 = false;
         }
      }
      ...
      {
         return this.var_609.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_609.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_753)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
