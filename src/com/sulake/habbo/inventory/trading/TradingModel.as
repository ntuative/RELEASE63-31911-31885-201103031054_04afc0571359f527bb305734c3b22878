package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1573:uint = 9;
      
      public static const const_192:uint = 0;
      
      public static const const_185:uint = 1;
      
      public static const const_408:uint = 2;
      
      public static const const_276:uint = 3;
      
      public static const const_494:uint = 4;
      
      public static const const_213:uint = 5;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_55.updateItemList(this.var_789);
         this.var_55.updateItemList(this.var_1484);
      ...
      public function close() : void
      {
         if(this.var_726)
         {
            if(this._state != const_192 && this._state != const_213)
            {
      ...
      {
         this.var_55.setMinimized(param1 != InventoryCategory.const_74);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_788 + " OTHER: " + this.var_1220);
         ...
         {
            case const_192:
               if(param1 == const_185 || param1 == const_213)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_55.alertPopup(TradingView.const_1067);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_789)
            {
               this.var_788 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_789)
            {
               this.var_55.alertPopup(TradingView.const_1043);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_265.length < const_1573)
         {
