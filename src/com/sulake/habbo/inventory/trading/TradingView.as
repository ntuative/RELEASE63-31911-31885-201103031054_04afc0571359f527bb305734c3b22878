package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_910:uint = 4284532064;
      
      private static const const_909:uint = 2577770;
      ...
      private var var_380:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_380 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1531 = this.createMinimizedWindow();
         }
         if(!this.var_2025)
         {
            return this.var_67;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.ownUserAccepts ? uint(const_910) : uint(const_909);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_20.otherUserAccepts ? uint(const_910) : uint(const_909);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_20.ownUserItems.getWithIndex(param2.id);
            if(!_loc3_)
            {
               return;
            }
            _loc4_ = _loc3_.peek();
            _loc5_ = this.var_20.getItemImage(_loc4_);
            _loc6_ = "${roomItem.name." + _loc4_.type + "}";
            if(_loc4_.category == FurniCategory.const_158)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1019)
            {
            ...
            this.var_380.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_548);
            this.var_380.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_380.hideDelayed();
         }
      }
      ...
      private function othersThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_20.otherUserItems.getWithIndex(param2.id);
            if(_loc3_ == null)
            {
               return;
            }
