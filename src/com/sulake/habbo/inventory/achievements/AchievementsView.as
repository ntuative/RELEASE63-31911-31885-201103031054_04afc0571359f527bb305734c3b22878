package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_65:AchievementsModel;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_59 = IItemListWindow(this._view.getChildByName("achievements_itemlist"));
         this.var_435 = new Timer(1000,1);
         this.var_435.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_276.events.addEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImageReady);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_435)
            {
               this.var_435.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
               this.var_435.reset();
               this.var_435 = null;
            }
            this._disposed = true;
      ...
      public function updateList() : void
      {
         ...
         var _loc1_:Array = this.var_65.getAchievements();
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_435.running);
         this.var_1219[param1.badgeId] = param1.badgeImage;
         if(!this.var_435.running)
         {
            this.var_435.start();
         }
      }
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1219[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_276.getBadgeImage(param2.badgeId);
            this.var_1219[param2.badgeId] = _loc4_;
         }
