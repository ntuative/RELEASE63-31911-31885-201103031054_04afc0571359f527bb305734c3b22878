package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_797:int = 0;
      
      protected var var_645:BitmapData;
      
      protected var var_2009:int;
      
      protected var var_1489:Boolean;
      
      protected var var_1980:Boolean;
      
      protected var var_2739:BitmapData;
      
      private const const_1972:int = 8947848;
      
      private const const_1973:int = 13421772;
      
      private const const_1684:Number = 1;
      
      private const const_1685:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this._mainCategory == FurniModel.const_42)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1308));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1979);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      {
         return this.var_797 == -1;
      }
      
      public function set isSelected(param1:Boolean) : void
      {
         if(this.var_197 != param1)
         {
            this.var_197 = param1;
            this.updateThumbData();
         }
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_753)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1685;
               _loc1_.blend = this.const_1685;
            }
            else
            {
               this._window.blend = this.const_1684;
               _loc1_.blend = this.const_1684;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1980 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2739;
               _loc5_.visible = true;
            }
            else
            {
