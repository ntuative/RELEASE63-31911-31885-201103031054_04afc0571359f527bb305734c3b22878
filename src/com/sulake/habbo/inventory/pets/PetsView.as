package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_65:PetsModel;
      
      private var _disposed:Boolean = false;
      
      private var var_260:IItemGridWindow;
      ...
      private var var_325:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_260 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_325);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_554.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_260.removeGridItem(_loc2_.window);
         if(this.var_325 == _loc2_)
         {
            this.var_325 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_554 == null || this.var_554.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_554.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_554.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_260.addGridItem(_loc2_.window);
            this.var_554.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_260.removeGridItems();
         this.var_554.reset();
         var _loc1_:Map = this.var_65.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_325.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_65.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_57)
         {
            ...
            {
               case "tab_floor":
                  this.var_65.switchCategory(FurniModel.const_42);
                  break;
               case "tab_wall":
                  this.var_65.switchCategory(FurniModel.const_48);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_325 != null)
         {
            this.var_325.setSelected(false);
         }
         this.var_325 = param1;
         if(this.var_325 != null)
         {
            this.var_325.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_65.roomSession != null)
         {
            _loc8_ = this.var_65.roomSession.arePetsAllowed;
            _loc9_ = this.var_65.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc8_ = this._avatarRenderer.createPetImage(param1,param2,_loc7_,AvatarScaleType.const_56,this);
            if(_loc8_ != null)
            {
               _loc8_.setDirection(AvatarSetType.const_34,param4);
               if(param5)
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_34);
               }
               else
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_50);
               }
               _loc8_.dispose();
            }
         }
