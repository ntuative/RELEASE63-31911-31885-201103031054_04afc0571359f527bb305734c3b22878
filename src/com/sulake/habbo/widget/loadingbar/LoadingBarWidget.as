package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_497:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_497.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_497 = null;
         }
         if(this.var_44 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_302,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_302,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         this.var_1229 = param1.clickUrl;
         var _loc2_:IDisplayObjectWrapper = this._window.findChildByName("image") as IDisplayObjectWrapper;
         if(_loc2_ == null)
         {
            return;
         }
         var _loc3_:int = Math.max(0,this.var_44.width - _loc2_.width);
         var _loc4_:int = Math.max(0,this.var_44.height - _loc2_.height);
         this._window.scale(_loc3_,_loc4_);
         if(this.var_497 == null)
         {
            this.var_497 = new Sprite();
            this.var_497.addChild(new Bitmap(this.var_44));
            this.var_497.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_497.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_44;
            }
         }
         _loc2_.setDisplayObject(this.var_497);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_302)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1229 != "")
         {
            HabboWebTools.openWebPage(this.var_1229);
         }
      }
   }
}
