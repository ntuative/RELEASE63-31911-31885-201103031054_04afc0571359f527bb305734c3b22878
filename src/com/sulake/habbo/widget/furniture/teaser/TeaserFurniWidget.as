package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1681:int = 0;
      
      private const const_1679:int = 1;
      
      private const const_1680:int = 2;
      
      private const const_1678:int = 3;
      
      private const const_1675:int = 4;
      
      private const const_1965:int = 0;
      
      private const const_1966:int = 1;
      
      private const const_1971:int = 2;
      
      private const const_1970:int = 3;
      
      private const const_1967:int = 4;
      
      private const const_1964:int = 5;
      
      private const const_1676:String = "deco_img";
      
      private const const_1677:String = "dialog_bg";
      
      private const const_1968:String = "%campaign%_dialog_bg.png";
      
      private const const_328:String = "%campaign%_gift_package.png";
      
      private const const_1963:String = "%campaign%_gift_content.png";
      
      private const const_1969:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1248 = this.var_158.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1248 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1249.length)
         {
            _loc2_ = this.var_1249.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_158 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_817,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_741,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_509:
               ...
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_741:
               ...
               if(_loc5_)
               {
                  ...
                  {
                     _loc2_ = this.const_1680;
                  }
               }
               else
               {
                  _loc2_ = this.const_1675;
               }
               this._shareId = null;
               this.var_1246 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_817:
               _loc2_ = this.const_1679;
               this.var_329 = param1.objectId;
         ...
         if(this._window && (this.var_1247 != _loc2_ || _loc3_ != this.var_166))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1247)
            {
               ...
               case this.const_1679:
                  ...
                  else if(this.var_375 == this.const_1964)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_166,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_1968.replace("%campaign%",this.var_166);
            this.setDecoImage(_loc5_,this.const_1677);
            _loc2_ = _loc2_.replace("%campaign%",this.var_166);
            this.setDecoImage(_loc2_,this.const_1676);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_887);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_166,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_166,"client.start_post",this._shareId);
         var _loc4_:String = this.var_158.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_166,_loc2_,_loc3_,this._shareId,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1246 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1246 == 1 ? "null" : InventoryCategory.const_131);
            }
         }
         this.sendConversionPoint("viral_" + this.var_166,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_625,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1249.push(new ImageDownloader(this,_assets,this.var_166,this.var_1248,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_1677:
            case this.const_1676:
      ...
      function onDecoImageReady(param1:ImageDownloader) : void
      {
         ...
         if(!this._window || this.var_166 != param1.campaignID)
         {
            return;
         }
