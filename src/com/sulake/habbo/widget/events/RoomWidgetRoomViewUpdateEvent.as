package com.sulake.habbo.widget.events
{
   ...
   public class RoomWidgetRoomViewUpdateEvent extends RoomWidgetUpdateEvent
   {
      ...
      public static const const_828:String = "RWRVUE_ROOM_VIEW_SCALE_CHANGED";
      
      public static const const_621:String = "RWRVUE_ROOM_VIEW_POSITION_CHANGED";
       
      
      private var var_1743:Rectangle;
      
      private var var_1744:Point;
      ...
      {
         if(this.var_1743 != null)
         {
            return this.var_1743.clone();
         }
         return null;
      }
