package com.sulake.habbo.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_1672:String = "button_ok";
      
      protected static const const_1671:String = "text_title";
      
      protected static const DESCRIPTION_NAME:String = "text_description";
      
      protected static const const_1962:String = "widget_notification_frame";
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_593)
            {
               while(this.var_593.length > 0)
               {
                  this.var_593.pop().dispose();
               }
               this.var_593 = null;
            }
            this._widget = null;
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_1671).caption = title;
         dialog.findChildByName(DESCRIPTION_NAME).caption = description;
         dialog.center();
         dialog.findChildByName(const_1672).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
      ...
      public function hideNotification(param1:IFrameWindow) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.var_593.indexOf(param1);
            if(_loc2_ > -1)
            {
               this.var_593.splice(_loc2_,1);
            }
            param1.dispose();
         }
      }
