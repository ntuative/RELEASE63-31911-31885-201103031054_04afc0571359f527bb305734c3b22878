package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1235:int = 11;
      
      private static const const_589:int = 18;
      
      private static const const_916:int = 16;
      
      private static const const_1236:int = 20;
      ...
      private var var_300:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1020 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2074 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_323 = new Timer(1000,1);
         this.var_323.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_384 = new Timer(10000,1);
         this.var_384.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_323.reset();
            this.var_323.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_323 = null;
         }
         if(this.var_384 != null)
         {
            this.var_384.reset();
            this.var_384.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_384 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_202,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_104,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_366,this.onWindowMoved);
         this.var_1553 = true;
         this.var_458 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_589 + const_916;
         _loc1_.x = const_589;
         _loc1_.y = const_1235;
      }
      ...
      {
         this.var_300 = param1 - (const_589 + const_916);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1020 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_458 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1236);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_458.length + 1)
            {
               _loc2_.text = "";
            }
            this.var_458 = _loc2_.text;
            if(!this.var_551)
            {
               this.var_551 = true;
               this.var_323.reset();
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_551);
      ...
      private function checkInputFieldLimits() : void
      {
         ...
         if(_loc1_.textWidth >= this.var_300)
         {
