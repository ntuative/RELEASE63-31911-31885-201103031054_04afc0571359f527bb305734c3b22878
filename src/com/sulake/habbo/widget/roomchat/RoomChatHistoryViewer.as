package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1308:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1122:int = 3;
       
      
      private var var_173:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_657 = false;
         this._widget = param1;
         this.var_173 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_173.state = RoomChatHistoryPulldown.const_227;
         ...
         this.var_47 = param2.createWindow("chatscroller","",HabboWindowType.const_974,HabboWindowStyle.const_41,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_173.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_227);
      }
      ...
      {
         return !!this.var_413 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_173.state == RoomChatHistoryPulldown.const_395 || this.var_173.state == RoomChatHistoryPulldown.const_487;
      }
      ...
      {
         if(!this.var_413 && !this.var_1566)
         {
            this.var_413 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_173.state = RoomChatHistoryPulldown.const_395;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_47 != null)
         {
            ...
            if(param2)
            {
               this.var_47.scrollV = this.var_594;
            }
         }
         if(this.var_173 != null)
         {
            this.var_173.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_412 > 0 && param2)
         {
            if(this.var_1719)
            {
               if(Math.abs(param1 - this.var_412) <= const_1122)
               {
                  return;
               }
               this.var_1719 = false;
            ...
            if(this.var_413)
            {
               ...
               _loc5_ = (param1 - this.var_412) / this.var_47.height;
               _loc3_ = this.var_594 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_412;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_47.scrollV < 1 - const_1308 / this.var_47.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1718)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_47 != null)
         {
            this.var_594 = this.var_47.scrollV;
         }
         if(this.var_47 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_594 - this.var_47.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
