package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1336:Array = null;
      
      private var var_1206:Array = null;
      
      private var var_1752:int = -1;
      
      private var var_1402:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1402 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_146,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_142,this.showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_361,this.update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_146,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_142,this.showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_361,this.update);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(this.var_59.scrollableRegion.height - this.var_59.height,0);
      ...
      private function createWindow() : Boolean
      {
         ...
         this.var_59 = this._window.findChildByName("choices") as IItemListWindow;
         if(this.var_59 == null)
         {
            return false;
         }
      ...
      private function vote(param1:int = -1) : void
      {
         ...
         if(this._window == null || this.var_59 == null)
         {
            return;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_59.numListItems)
         {
            _loc2_ = this.var_59.getListItemAt(_loc4_) as IBorderWindow;
            if(_loc2_ == null)
            {
               return;
            }
            if(_loc4_ != this.var_1752)
            {
               _loc2_.blend = 0.5;
            }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc4_ = Number(param1) / this.var_1402;
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1402 - param1) / 1000,0);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2422;
      ...
      private function showVoteResult(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_59.numListItems != param1.votes.length)
         {
            return;
         }
         var _loc3_:int = 0;
         while(_loc3_ < this.var_59.numListItems)
         {
            _loc4_ = this.var_59.getListItemAt(_loc3_) as IWindowContainer;
            if(_loc4_ != null)
            {
