package com.sulake.habbo.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1071:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_239 = new PollOfferDialog(this._id,param1,this.var_1071);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_239 = new PollContentDialog(this._id,param1,param3,this.var_1071);
      }
      ...
      {
         this.var_1071.windowManager.alert("${poll_thanks_title}",this.var_1510,0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
