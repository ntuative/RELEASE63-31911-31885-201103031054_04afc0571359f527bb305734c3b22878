package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1720:String = "infostand_user_view";
      
      private const const_1719:String = "infostand_furni_view";
      
      private const const_1722:String = "infostand_pet_view";
      
      private const const_1721:String = "infostand_bot_view";
      
      private var var_1218:InfoStandFurniView;
      ...
      private var var_1482:InfostandUserData;
      ...
      private const const_2013:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1218 = new InfoStandFurniView(this,this.const_1719,this._catalog);
         this.var_134 = new InfoStandUserView(this,this.const_1720);
         this.var_372 = new InfoStandPetView(this,this.const_1722,this._catalog);
         this.var_434 = new InfoStandBotView(this,this.const_1721);
         this.var_1482 = new InfostandUserData();
         this.var_609 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_163 = new Timer(this.const_2013);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_61,HabboWindowStyle.const_41,HabboWindowParam.const_41,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_161,this.onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_67,this.onUserBadges);
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_686,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_692,this.onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_101,this.onPetInfo);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_161,this.onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_67,this.onUserBadges);
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_686,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_692,this.onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_101,this.onPetInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_401,this.var_372.getCurrentPetId()));
      }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_134.setTags(param1.tags,this.var_2726);
         }
      }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_369,param1.id,param1.category);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_157:
               ...
               {
                  _loc2_ = param1.id == this.var_1482.userRoomId;
                  break;
               }
