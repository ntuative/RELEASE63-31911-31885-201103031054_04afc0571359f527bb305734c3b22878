package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_438:IFrameWindow;
      ...
      private const const_2014:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1221 = new Map();
         this.var_373 = new Timer(this.const_2014);
         this.var_373.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1221.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_524);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1221.getValue(this.var_524) as CommandConfiguration;
      ...
      {
         this.var_1221.remove(param1);
         this.var_1221.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_769,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_40 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this.var_40 == null)
         {
            throw new Error("Failed to construct command window from XML!");
         }
         this.var_40.setParamFlag(WindowParam.const_95,true);
         this.var_40.context.getDesktopWindow().addEventListener(WindowEvent.const_49,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_438 == null)
         {
            ...
            this.var_438 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_438 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_438.x = 200;
            this.var_438.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_401,this.var_524));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_530,this.var_524,this.var_1938 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_530,this.var_524,this.var_1938 + " " + _loc5_);
