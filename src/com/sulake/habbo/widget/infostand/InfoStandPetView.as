package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1992:int = 152;
      
      private const const_1981:int = 16;
      
      private const const_1304:int = 4;
      
      private const const_1984:uint = 14342874;
      
      private const const_1989:uint = 3815994;
      
      private const const_1983:uint = 2085362;
      
      private const const_1980:uint = 39616;
      
      private const const_1990:uint = 10513106;
      
      private const const_1988:uint = 8734654;
      
      private const const_1985:uint = 9094430;
      
      private const const_1982:uint = 6200576;
      
      private const const_1991:String = "happiness";
      
      private const const_1986:String = "experience";
      
      private const const_1987:String = "energy";
      ...
      private function updateWindow() : void
      {
         ...
         this.var_66.visible = this.var_66.width > 0;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1991,param1.nutrition,param1.nutritionMax,this.const_1980,this.const_1983);
         this.updateStateElement(this.const_1986,param1.experience,param1.experienceMax,this.const_1988,this.const_1990);
         this.updateStateElement(this.const_1987,param1.energy,param1.energyMax,this.const_1982,this.const_1985);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_1992,this.const_1981,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_1984);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_1989);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1304,_loc7_.width - 2,_loc7_.height - 2 - this.const_1304);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1304);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_524) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _loc4_ = 0;
         while(_loc4_ < this.var_66.numListItems)
         {
            _loc12_ = this.var_66.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc12_ != null)
            {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_192.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_192.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_192.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
         ...
         var _loc10_:* = [];
         this.var_66.groupListItemsWithTag("CMD_BUTTON",_loc10_,true);
         for each(_loc11_ in _loc10_)
         {
            ...
            _loc11_.addEventListener(WindowEvent.const_49,this.onButtonResized);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_193 && this.var_193.getPetId() == this.var_524)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1517,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_571,this._widget.petData.ownerId);
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = this.var_66.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }
