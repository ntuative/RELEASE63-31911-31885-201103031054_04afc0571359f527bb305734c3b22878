package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_66:IItemListWindow;
      
      private var var_160:IFrameWindow;
      
      private var var_624:IWindow;
      
      private var var_192:IBorderWindow;
      
      private var var_1161:TagListRenderer;
      
      private var var_132:IBorderWindow;
      
      private var var_2607:int;
      
      private const const_965:int = 5;
      
      private const const_1706:int = 39;
      
      private const const_1708:int = 7829367;
      
      private const const_1707:int = 16777215;
      
      private const const_2004:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1161 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_53 == null || this.var_192 == null || this.var_66 == null)
         {
            return;
         }
         this.var_66.width = this.var_66.scrollableRegion.width;
         this.var_53.height = this.var_53.scrollableRegion.height;
         this.var_192.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_192.width,this.var_66.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_192.width < this.var_66.width)
         {
         ...
         {
            this.var_66.x = this._window.width - this.var_66.width;
            this.var_192.x = 0;
         }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_66 = this._window.getListItemByName("button_list") as IItemListWindow;
         var _loc3_:* = [];
         this.var_66.groupListItemsWithTag("CMD_BUTTON",_loc3_,true);
         ...
         {
            this.var_53 = this.var_192.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc5_:IBitmapWrapperWindow = this.var_192.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc6_:IWindow = this.var_192.findChildByTag("close");
         if(_loc6_ != null)
         {
         ...
         {
            _loc7_ = 0;
            while(_loc7_ < this.var_66.numListItems)
            {
               _loc12_ = this.var_66.getListItemAt(_loc7_) as IRegionWindow;
               if(_loc12_ != null)
               {
         ...
         while(_loc7_ < 5)
         {
            _loc9_ = this.var_192.findChildByName("badge_" + _loc7_);
            if(_loc9_ != null)
            {
               _loc9_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.showBadgeInfo);
               _loc9_.addEventListener(WindowMouseEvent.const_25,this.hideBadgeInfo);
            }
            _loc7_++;
         }
         _loc9_ = this.var_192.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_132.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_132.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_132.x = _loc5_.left - this.var_132.width;
         this.var_132.y = _loc5_.top + (_loc5_.height - this.var_132.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_132.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_132.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_132.x = _loc7_.left - this.var_132.width;
         this.var_132.y = _loc7_.top + (_loc7_.height - this.var_132.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_132 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_132 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_965;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1708;
            }
            else
            {
               _loc3_.textColor = this.const_1707;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_965;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_389,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_389,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1161.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_66.getListItemByName(param1) as IRegionWindow;
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_66.getListItemByName(param1);
         if(_loc3_ != null)
         {
            _loc3_.visible = param2;
            this.var_66.arrangeListItems();
         }
      }
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = this.var_66.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_983:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1219:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2607 > this.const_2004 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2607 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1708;
            if(_loc3_.length >= this.const_1706)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1706 - 1);
            }
         }
      }
      ...
      {
         this.var_160 = this._widget.getXmlWindow("give_badge") as IFrameWindow;
         this.var_160.center();
         this.var_160.procedure = this.badgesEventProc;
         this.var_160.visible = param1;
      }
      
      public function updateGivableBadges() : void
      {
         if(this.var_160 && this.var_160.visible)
         {
            this.showGivableBadges();
         }
      }
      ...
      private function showGivableBadges() : void
      {
         ...
         this.var_624 = null;
         var _loc2_:IItemGridWindow = this.var_160.findChildByName("list.badges") as IItemGridWindow;
         if(_loc2_)
         {
      ...
      public function setGivableBadgeImage(param1:Array, param2:BitmapData) : void
      {
         ...
         var _loc3_:IItemGridWindow = this.var_160.findChildByName("list.badges") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      private function badgesEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = -1;
               _loc4_ = this.var_160.findChildByName("list.badges") as IItemGridWindow;
               if(_loc4_)
               {
                  _loc3_ = _loc4_.getGridItemIndex(this.var_624);
               }
               if(_loc3_ <= -1)
               {
                  return;
