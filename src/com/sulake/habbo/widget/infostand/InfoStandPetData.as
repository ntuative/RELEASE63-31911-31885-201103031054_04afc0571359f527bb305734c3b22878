package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1850 = param1.id;
         this._type = param1.petType;
         this.var_2161 = param1.petRace;
         this.var_44 = param1.image;
         this.var_2635 = param1.isOwnPet;
         this.var_2558 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1452 = param1.level;
         this.var_2559 = param1.levelMax;
         this.var_2411 = param1.experience;
         this.var_2556 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2560 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2557 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2159 = param1.roomIndex;
