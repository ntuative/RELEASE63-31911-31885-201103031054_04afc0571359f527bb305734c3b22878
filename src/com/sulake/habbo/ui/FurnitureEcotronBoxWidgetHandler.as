package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return RoomWidgetEnum.const_526;
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_780,RoomWidgetEcotronBoxOpenMessage.const_788,RoomWidgetEcotronBoxOpenedMessage.const_1639];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_780:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc8_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_64,_loc2_.id,_loc6_,_loc7_);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_788:
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc3_:RoomWidgetEcotronBoxDataUpdateEvent = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_91,0,this._name,false,param2);
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_317:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     if(_loc3_ != null)
                     {
                        _loc5_ = new RoomWidgetEcotronBoxDataUpdateEvent(RoomWidgetEcotronBoxDataUpdateEvent.const_91,0,this._name,false,_loc3_.data);
