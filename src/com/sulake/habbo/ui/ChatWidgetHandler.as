package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_634:Map = null;
      
      private var var_1903:Map = null;
      
      private var var_1197:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1196:Number = 0.0;
      
      private var var_776:Point = null;
      ...
      public function ChatWidgetHandler()
      {
         ...
         this.var_634 = new Map();
         this.var_1903 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_431.length)
            {
               _loc2_ = this.var_431.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_305 != null)
         {
            ...
            {
               _loc2_ = this.var_305.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1197)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_755,RoomWidgetChatSelectAvatarMessage.const_900];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_755:
               if(this._container != null && this._container.roomSession != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1045))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_40) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1045))
                              {
                     ...
                     {
                        case RoomWidgetChatMessage.const_127:
                           this._container.roomSession.sendChatMessage(_loc3_.text);
                           break;
                        case RoomWidgetChatMessage.const_112:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_900:
      ...
      {
         return [RoomSessionChatEvent.const_195];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_195:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_186)
                           {
                              _loc13_ = this.var_305.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_431.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_634.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_186:
                                       _loc13_ = this.getPetImage(_loc16_);
                                       _loc12_ = uint(this.var_634.getValue(_loc16_));
                                       break;
                                    default:
                                       _loc17_ = this._container.avatarRenderManager.createAvatarImage(_loc16_,AvatarScaleType.const_92,null,this);
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_634.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_186)
                                    {
                                       this.var_305.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_431.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1196 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1196);
            }
            if(this.var_776 == null)
            {
               ...
               this.var_517.y = 0;
               this.var_517.z = 0;
               this.var_776 = _loc4_.getScreenPoint(this.var_517);
               this.var_1196 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_517.x = 0;
            this.var_517.y = 0;
            this.var_517.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_517);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_776.x || _loc8_.y != this.var_776.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_776,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_305)
         {
            _loc2_ = this.var_305.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_431)
         {
            _loc2_ = this.var_431.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1197.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_92,this);
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_634.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1903.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1903.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_305)
            {
               this.var_305.add(_loc3_,param2);
            }
         }
      }
   }
