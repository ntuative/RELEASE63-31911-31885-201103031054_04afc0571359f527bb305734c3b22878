package com.sulake.habbo.ui
{
   ...
   public class LoadingBarWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_568;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(AdEvent.const_439);
         _loc1_.push(AdEvent.const_461);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_107);
         _loc1_.push(RoomWidgetLoadingBarUpdateEvent.const_302);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetLoadingBarUpdateEvent.const_107:
               ...
               break;
            case RoomWidgetLoadingBarUpdateEvent.const_302:
               this._container.events.dispatchEvent(param1);
         }
      }
