   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_166,this.onUserTags);
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_161,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_101,this.onPetInfo);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_166,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_137,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_161,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_101,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_616.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_616.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_369);
         _loc1_.push(RoomWidgetUserActionMessage.const_890);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_836);
         _loc1_.push(RoomWidgetUserActionMessage.const_571);
         _loc1_.push(RoomWidgetUserActionMessage.const_705);
         _loc1_.push(RoomWidgetUserActionMessage.const_719);
         _loc1_.push(RoomWidgetUserActionMessage.const_768);
         _loc1_.push(RoomWidgetUserActionMessage.const_612);
         _loc1_.push(RoomWidgetUserActionMessage.const_743);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_274);
         _loc1_.push(RoomWidgetFurniActionMessage.const_831);
         _loc1_.push(RoomWidgetFurniActionMessage.const_666);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_655);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_770);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_760);
         _loc1_.push(RoomWidgetUserActionMessage.const_468);
         _loc1_.push(RoomWidgetUserActionMessage.const_632);
         _loc1_.push(RoomWidgetUserActionMessage.const_458);
         _loc1_.push(RoomWidgetUserActionMessage.const_1440);
         _loc1_.push(RoomWidgetPetCommandMessage.const_530);
         _loc1_.push(RoomWidgetPetCommandMessage.const_769);
         _loc1_.push(RoomWidgetUserActionMessage.const_450);
         _loc1_.push(RoomWidgetUserActionMessage.const_401);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_882);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_468)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_401 || param1.type == RoomWidgetUserActionMessage.const_450 || param1.type == RoomWidgetUserActionMessage.const_458)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_369:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_890:
            ...
            case RoomWidgetUserActionMessage.const_809:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1071,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_735:
               ...
               break;
            case RoomWidgetUserActionMessage.const_836:
            ...
            case RoomWidgetUserActionMessage.const_571:
               ...
               break;
            case RoomWidgetUserActionMessage.const_705:
            ...
            case RoomWidgetUserActionMessage.const_719:
               ...
               break;
            case RoomWidgetUserActionMessage.const_768:
            ...
            case RoomWidgetUserActionMessage.const_612:
               ...
               break;
            case RoomWidgetUserActionMessage.const_743:
               this._container.sessionDataManager.openHabboHomePage(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_458:
            ...
            case RoomWidgetGiveBadgeMessage.GIVE_BADGE:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_831:
            ...
            case RoomWidgetFurniActionMessage.const_274:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_666:
            ...
            case RoomWidgetUserActionMessage.const_401:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_655:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_770:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_760:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_278);
               _loc6_.id = param1.id;
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_391);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1007);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1149);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_186)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_179)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_623)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_480);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_117)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_125)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_717);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_983;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1219;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1456);
               }
               else
               {
               ...
               _loc19_ = _loc11_.sex;
               _loc20_ = this._container.avatarRenderManager.createAvatarImage(_loc18_,AvatarScaleType.const_56,_loc19_);
               if(_loc20_ != null)
               {
                  _loc20_.setDirection(AvatarSetType.const_34,4);
                  _loc13_.image = _loc20_.getImage(AvatarSetType.const_34,true);
                  _loc20_.dispose();
               }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_67,RoomSessionUserGivableBadgesEvent.const_67];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_67:
               ...
               break;
            case RoomSessionUserGivableBadgesEvent.const_67:
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_56,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_616.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_616.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_717);
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            _loc4_ = this._container.avatarRenderManager.createPetImageFromFigure(param1,AvatarScaleType.const_56,null);
            if(_loc4_ != null)
            {
