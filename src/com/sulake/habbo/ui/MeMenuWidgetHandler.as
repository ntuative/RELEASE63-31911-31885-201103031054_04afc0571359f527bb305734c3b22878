   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_291,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_825,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_852,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_179 != null)
            {
               this.var_179.events.removeEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_555,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_113,this.onHelpTutorialEvent);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_291,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_825,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_852,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_555,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_113,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1405)
            {
               ...
               this.var_1405 = _loc2_;
               this.var_1758 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1758;
            }
         }
         if(this.var_179 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1141,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_775);
         _loc1_.push(RoomWidgetDanceMessage.const_704);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_845);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_894);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_748);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_790);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_834);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_386);
         _loc1_.push(RoomWidgetStopEffectMessage.const_815);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1504);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1164);
         _loc1_.push(RoomWidgetToolbarMessage.const_634);
         _loc1_.push(RoomWidgetToolbarMessage.const_668);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_372);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1641);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1138);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_776);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_873);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_740);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1375);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_897);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_696);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_613);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_377);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_873:
               ...
               break;
            case RoomWidgetWaveMessage.const_775:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_704:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_845:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_894:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_748:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_386:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1157)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_175,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_834:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_996:
                        this._catalog.openCatalogPage(CatalogPageName.const_1597,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1106:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_311);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1527:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_790:
            case RoomWidgetStopEffectMessage.const_815:
            ...
            case RoomWidgetToolbarMessage.const_634:
               ...
               if(this.var_179)
               {
                  this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                     if(this._container != null && this._container.sessionDataManager != null)
                     {
                        _loc12_ = this._container.sessionDataManager.hasUserRight("fuse_use_club_dance",HabboClubLevelEnum.const_40);
                     }
            ...
            case RoomWidgetToolbarMessage.const_668:
               ...
               {
                  this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_481,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_372:
               ...
               if(this._container)
               {
                  ...
                  _loc21_ = 0;
                  if(this._container.sessionDataManager.hasUserRight("fuse_use_club_outfits",HabboClubLevelEnum.const_40))
                  {
                     _loc21_ = 0;
                  }
                  if(this._container.sessionDataManager.hasUserRight("fuse_use_vip_outfits",HabboClubLevelEnum.const_43))
                  {
                     _loc21_ = 0;
                  }
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_446));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_740:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_402,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_897:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_402,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_696:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_402,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_613:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_463));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_377:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_642));
      }
      ...
      private function onHabboClubSubscriptionChanged(param1:Event = null) : void
      {
         ...
         if(this._inventory != null)
         {
            ...
            if(this._container != null && this._container.sessionDataManager != null)
            {
               _loc2_ = this._container.sessionDataManager.hasUserRight("fuse_use_club_dance",HabboClubLevelEnum.const_40);
            }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_113:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_113));
               break;
            case HabboHelpTutorialEvent.const_555:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_556));
         }
      }
