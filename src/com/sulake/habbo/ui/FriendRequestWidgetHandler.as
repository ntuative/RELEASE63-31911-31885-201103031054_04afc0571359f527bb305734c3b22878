package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_383;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_727);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_652);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_675);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_727:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_652:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_675:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_144);
         _loc1_.push(FriendRequestEvent.const_46);
         _loc1_.push(FriendRequestEvent.const_297);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_144:
               ...
               break;
            case FriendRequestEvent.const_46:
            case FriendRequestEvent.const_297:
