package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_274:CatalogViewer;
      
      private var var_324:ICatalogNavigator;
      
      private var var_100:Purse;
      
      private var var_90:RecyclerLogic;
      ...
      private var var_275:ChargeConfirmationDialog;
      ...
      private var var_2075:GiftWrappingConfiguration;
      
      private var var_1022:ClubGiftController;
      ...
      {
         var _loc4_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_100.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_100.getActivityPointsForType(param1.activityPointType))
         {
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_324.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_168.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_168.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_276.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_276.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_83)
         {
            _loc3_ = this.var_276.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_668.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_100.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_100.getActivityPointsForType(Purse.const_188)));
         var _loc1_:int = 0;
         if(!this.var_100.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_100.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_100.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_100.clubPeriods));
         }
      ...
      {
         this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_666)
         {
            if(!this.var_276.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
            events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(this.var_90 != null && this.getCurrentLayoutCode() == "recycler")
            {
         ...
         this.setupInventoryForRecycler(this.var_90.active && this._mainContainer.visible);
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_274.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_324 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_274 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_274.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               this.var_1556 = param1.session.isPrivateRoom;
               if(this.var_90 != null)
               {
                  this.var_90.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_97:
               ...
               if(this.var_90 != null)
               {
                  this.var_90.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_90 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_121 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1022 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_324.buildCatalogIndex(_loc2_);
         if(this.var_667 && this.var_667 != "")
         {
            this.var_324.openPage(this.var_667);
            this.var_667 = "";
            this.var_828 = -1;
         }
         else if(this.var_828 > -1)
         {
            this.var_324.openPageById(this.var_828,this.var_1555);
            this.var_828 = -1;
            this.var_1555 = -1;
            this.var_667 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_274.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_274 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_274.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_100.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2076 && this.var_553 != null)
         {
            this.var_553.playSound(HabboSoundTypesEnum.const_1194);
         }
         this.var_2076 = false;
         if(this.var_275 != null)
         {
            this.var_275.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_72,this.var_100.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_100.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2077 && this.var_553 != null)
         {
            this.var_553.playSound(HabboSoundTypesEnum.const_1217);
         }
         this.var_2077 = false;
         if(this.var_275 != null)
         {
         ...
         if(_loc2_.type == Purse.const_188)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_105,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_100.activityPoints = _loc2_.points;
         this.updatePurse();
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_105,_loc2_.points["null"]));
         }
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_100.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_100.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_100.isVIP = _loc2_.isVIP;
         this.var_100.pastClubDays = _loc2_.pastClubDays;
         this.var_100.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1022.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_90 == null)
         {
            return;
         }
         this.var_90.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_90.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_90.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_274.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_121 != null)
         {
            this.var_121.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_121 != null)
         {
            this.var_121.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_121 != null)
         {
            this.var_121.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2075 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_121.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_275 == null)
         {
            this.var_275 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_275.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_668.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_668.add(_loc2_.productCode,_loc3_.slice());
            this.var_274.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == this.var_168.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_168.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_198)
         {
            _loc3_ = this.var_168.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
