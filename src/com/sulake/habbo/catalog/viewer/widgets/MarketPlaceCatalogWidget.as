package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1694:int = 2;
      
      private const const_1994:int = 40;
      
      private const const_1993:int = 10;
      
      private var var_730:Array;
      
      private var var_1385:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_486)
         {
            this.var_486.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_486 = null;
         }
      }
      ...
      {
         var _loc1_:XML = this.method_4("marketPlaceWidget");
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_730 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_730 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_730));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_595)
         {
            _loc3_ = this.method_4("marketplace_offers_item");
            if(!_loc3_)
            {
               return;
            }
            ...
            this.var_595 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_595)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1694,_loc2_.length);
         if(!this.var_486)
         {
            this.var_486 = new Timer(25);
            this.var_486.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1114 = 0;
         this.populateList();
         this.var_486.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1114 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1114));
            ++this.var_1114;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_595 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_595.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1693);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_730.length)
         {
            _loc4_ = this.var_730[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_104)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1993;
                  break;
               case "search_input":
                  _loc8_ = this.const_1994;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1385.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_57)
      ...
      private function method_4(param1:String) : XML
      {
