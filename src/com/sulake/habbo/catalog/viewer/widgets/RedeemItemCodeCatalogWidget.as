package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_955.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_955 = null;
         }
         if(this.var_954 != null)
         {
            this.var_954.removeEventListener(WindowKeyboardEvent.const_202,this.windowKeyEventProcessor);
            this.var_954 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_955 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_955 != null)
         {
            this.var_955.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_954 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_954 != null)
         {
            this.var_954.addEventListener(WindowKeyboardEvent.const_202,this.windowKeyEventProcessor);
         }
         return true;
      }
