package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_2485:XML;
      
      private var var_946:IWindowContainer;
      
      private var var_605:IButtonWindow;
      
      private var var_2827:IButtonWindow;
      
      private var var_1792:ITextWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_650,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            this.var_2485 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_650,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _window.removeChild(this.var_946);
         ...
         this.var_1792 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1790 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1791 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2791 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_605 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_605 != null)
         {
            if(this.var_1413 != null)
            {
               this.var_605.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1413);
            }
            else
            {
               this.var_605.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1413);
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1792 != null)
         {
            ...
            this.var_1792.caption = "${catalog.purchase.price.credits}";
         }
         var _loc3_:String = this.var_91.activityPointType == Purse.const_188 ? "pixels" : "activitypoints";
         if(this.var_1790 != null)
         {
            ...
            this.var_1790.caption = _loc2_.getKey(_loc4_);
         }
         if(this.var_1791 != null)
         {
            ...
            this.var_1791.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_2486 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_91 != null)
         {
            ...
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_91,page.pageId,this.var_2486);
         }
      }
   }
}
