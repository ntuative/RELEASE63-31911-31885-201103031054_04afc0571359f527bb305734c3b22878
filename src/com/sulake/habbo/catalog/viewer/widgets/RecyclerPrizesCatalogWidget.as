package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1055:PrizeViewer;
      
      private var _itemList:IItemListWindow;
      
      private var var_1614:XML;
      
      private var var_1613:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1055 = new PrizeViewer();
         this.var_700 = this.recycler.getPrizeTable();
         ...
         this.var_1613 = _loc1_.content as XML;
         this.populateItemGrid();
         if(this.var_700.length > 0 && this.var_700[0].prizes.length > 0)
         {
            this.select(this.var_700[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_700.length)
         {
            this.createLevelItem(this.var_700[_loc2_]);
            _loc2_++;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1613) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_1614) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1055.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
