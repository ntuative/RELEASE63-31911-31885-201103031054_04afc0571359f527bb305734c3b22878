package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_483:IItemGridWindow;
      
      private var var_1368:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_909 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1107 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1699 = new Point(this.var_84.x,this.var_84.y);
         this.var_483 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1368 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1700 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_483 != null)
         {
            this.var_483.visible = false;
            this.var_483.destroyGridItems();
         }
         ...
         this.var_909.text = _loc4_;
         this.var_1107.text = _loc5_;
         this.var_909.height = this.var_909.textHeight + 5;
         this.var_1107.y = this.var_909.y + this.var_909.height;
         this.var_1107.height = Math.max(130,this.var_1107.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_429:
                  _loc6_ = this.var_1700.clone();
                  if(this.var_483 != null)
                  {
                     this.var_483.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_483,this.var_1368,this.var_1614);
                     this.var_483.scrollV = 0;
                  }
                  break;
               case Offer.const_501:
               case Offer.const_544:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_243:
                        ...
                        _loc6_ = new BitmapData(this.var_84.width,this.var_84.height,false,_loc13_);
                        _loc14_ = null;
                        _loc15_ = page.viewer.catalog as HabboCatalog;
                        if(_loc15_.avatarRenderManager != null)
                        {
                           _loc17_ = _loc15_.sessionDataManager.figure;
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_56);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_50,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_296,AvatarAction.const_581);
                              _loc16_.appendAction(AvatarAction.const_289,_loc8_.productClassId);
                              _loc16_.endActionAppends();
                              _loc16_.updateAnimationByFrames(1);
                              _loc16_.updateAnimationByFrames(1);
                              _loc14_ = _loc16_.getImage(AvatarSetType.const_34,true);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_84);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2343)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2343 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            if(this.var_84.bitmap == null)
            {
               this.var_84.bitmap = new BitmapData(this.var_84.width,this.var_84.height,true,16777215);
            }
            this.var_84.bitmap.fillRect(this.var_84.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_84.width - param1.width) / 2,(this.var_84.height - param1.height) / 2);
            this.var_84.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_84.invalidate();
            this.var_84.x = this.var_1699.x;
            this.var_84.y = this.var_1699.y;
            if(param3 != null)
            {
               this.var_84.x += param3.x;
               this.var_84.y += param3.y;
            }
         }
         if(param2)
         {
