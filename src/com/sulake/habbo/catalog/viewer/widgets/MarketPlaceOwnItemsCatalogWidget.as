package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      override public function init() : Boolean
      {
         ...
         _loc3_ = this.method_4("marketplace_ongoing_item");
         if(_loc3_ != null)
         {
            _loc2_ = _loc1_.buildFromXML(_loc3_) as IWindowContainer;
            if(_loc2_)
            {
               this.var_1091.add(MarketPlaceOfferState.const_979,_loc2_);
            }
         }
         _loc3_ = this.method_4("marketplace_sold_item");
         if(_loc3_ != null)
         {
            _loc2_ = _loc1_.buildFromXML(_loc3_) as IWindowContainer;
            if(_loc2_)
            {
               this.var_1091.add(MarketPlaceOfferState.const_512,_loc2_);
            }
         }
         _loc3_ = this.method_4("marketplace_expired_item");
         if(_loc3_ != null)
         {
            _loc2_ = _loc1_.buildFromXML(_loc3_) as IWindowContainer;
            if(_loc2_)
            {
               this.var_1091.add(MarketPlaceOfferState.const_200,_loc2_);
            }
         }
      ...
      private function updateList(param1:Map) : void
      {
         ...
         this.updateStatusDisplay(this.const_1694,_loc6_.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc10_ = _loc6_[_loc7_];
            _loc11_ = param1.getValue(_loc10_) as MarketPlaceOfferData;
            if(_loc11_.status == MarketPlaceOfferState.const_512)
            {
               _loc5_++;
            }
            _loc4_ = this.var_1091.getValue(_loc11_.status);
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_979)
                  {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_200)
                  {
      ...
      {
         var _loc1_:XML = this.method_4("marketPlaceOwnItemsWidget");
         if(!_loc1_ || !window)
         {
            return;
         }
