package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_273:CatalogObjectMover;
      ...
      {
         var _loc1_:XML = this.method_4("recyclerWidgetInactive");
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function displayTimeOutView(param1:int) : void
      {
         ...
         var _loc4_:XML = this.method_4("recyclerWidgetTimeout");
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         var _loc1_:XML = this.method_4("recyclerWidget");
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_197)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_197)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_25:
               if(this.var_273 != null)
               {
                  this.var_273.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(this.var_273 == null)
               {
                  this.var_273 = new CatalogObjectMover();
                  this.var_273.mainContainer = window;
                  this.var_273.roomEngine = _loc3_;
               }
               this.var_273.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
      ...
      private function onSlotMouseEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(event.type == WindowMouseEvent.const_59)
         {
