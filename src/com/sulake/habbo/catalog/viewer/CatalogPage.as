package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1674:String = "ctlg_";
       
      
      protected var var_2001:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1055:ICatalogViewer;
      ...
      private var var_522:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1216:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_522 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1217);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1217);
      }
      ...
      {
         var _loc2_:String = const_1674 + param1;
         ...
         this.var_2001 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2001) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1488:
               if(this.var_1216 == null)
               {
                  this.var_1216 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1216);
               }
               break;
            case CatalogWidgetEnum.const_1633:
               this.var_48.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1420:
               this.var_48.push(new ProductViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1522:
               this.var_48.push(new SingleViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1626:
            ...
            case CatalogWidgetEnum.const_1630:
               ...
               break;
            case CatalogWidgetEnum.const_1450:
            ...
            case CatalogWidgetEnum.const_1436:
               ...
               break;
            case CatalogWidgetEnum.const_1509:
               this.var_48.push(new TrophyCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1656:
            ...
            case CatalogWidgetEnum.const_1592:
               ...
               break;
            case CatalogWidgetEnum.const_1370:
               this.var_48.push(new MarketPlaceOwnItemsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1423:
            ...
            case CatalogWidgetEnum.const_1566:
               ...
               break;
            case CatalogWidgetEnum.const_1610:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_522.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_522 != null)
         {
            return this.var_522.dispatchEvent(param1);
         }
         return false;
      }
   }
