package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1929:int = 1;
      
      public const const_1838:int = 2;
      
      public const const_2018:int = 3;
      ...
      private var var_2661:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_262);
            this.var_262 = null;
         }
         if(this.var_304 != null)
         {
            this.disposeOffers(this.var_304);
            this.var_304 = null;
         }
         this._disposed = true;
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_202)
         {
            this.var_202 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_202.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2660,this.var_2659,this.var_2516,this.var_2658);
      }
      ...
      {
         if(!this.var_262 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_262.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
         ...
         this.showConfirmation(this.const_1929,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_304.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_304.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_512)
            {
               this.var_304.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_262.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2649 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_304.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_262.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_262.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_262.add(parser.offerId,updateItem);
            }
            this.var_262.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_1838,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_304.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2599 || param1.furniTypeId != this.var_2598)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         {
            _loc3_ = this._catalog.getFurnitureData(param1.furniId,ProductTypeEnum.const_83);
            if(_loc3_)
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1340)
               {
                  _loc2_ = true;
               }
            }
