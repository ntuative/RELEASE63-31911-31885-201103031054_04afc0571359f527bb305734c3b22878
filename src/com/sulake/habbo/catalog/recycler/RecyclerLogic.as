package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_945:int = 0;
      
      private static const const_416:int = 1;
      
      private static const const_944:int = 2;
      ...
      {
         return this.var_601 != const_945;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1742 != RecyclerStatusMessageEvent.const_1110;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_601 == const_416;
      }
      ...
      {
         this.var_601 = const_944;
         this.var_111 = new Array(const_197);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1742)
         {
            case RecyclerStatusMessageEvent.const_1541:
               this.var_601 = const_416;
            ...
            case RecyclerStatusMessageEvent.const_1110:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1629:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_992:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1457:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_111.length > 0)
         {
            oldObjectData = this.var_111[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_197)
            {
               oldObjectData = this.var_111[newSlotId];
         ...
         this.var_111[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_111[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_111[param1].id))
         {
            return;
         }
         this.var_111[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_111.length)
         {
            _loc3_ = this.var_111[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_111.length < const_197)
         {
            return false;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_111.length)
         {
            if(this.var_111[_loc1_] == null)
            {
               return false;
            }
            _loc1_++;
