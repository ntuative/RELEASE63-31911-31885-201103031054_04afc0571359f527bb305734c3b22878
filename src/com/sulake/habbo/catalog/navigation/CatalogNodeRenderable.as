package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1306:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1378:XML;
      
      private static var var_1379:XML;
       
      
      private var var_1715:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2780:IWindowContainer;
      ...
      public function addToList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            ...
            param1.addListItem(this.var_59);
         }
      }
      ...
      public function removeFromList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            param1.removeListItem(this.var_59);
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1715 == 4294967295)
            {
               this.var_1715 = _loc1_.color;
            }
            _loc1_.color = const_1306;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1584;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1612;
            }
         }
      }
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(this.var_59);
            }
         }
         if(this.var_59 != null)
         {
            this.var_59.visible = true;
            this.var_59.height = this.var_59.numListItems * 21;
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_59);
            }
         }
         if(this.var_59 != null)
         {
            this.var_59.height = 0;
      ...
      {
         this.var_59 = navigator.catalog.windowManager.buildFromXML(var_1379) as IItemListWindow;
         if(this.var_59 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1378) as IWindowContainer;
         }
         else
         {
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_28,this.onIconImageReady);
      }
