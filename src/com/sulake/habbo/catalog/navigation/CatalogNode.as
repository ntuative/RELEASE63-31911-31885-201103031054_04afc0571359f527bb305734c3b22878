package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNode implements ICatalogNode
   {
      ...
      private static const const_1284:Array = [4293190884,4293914607,4294957908,4289454682,4289431551,4285716709,4294016606,4293326172,4293694138,4285383659,4293082689,4288782753];
      ...
      public function CatalogNode(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         this._children = [];
         super();
         this.var_1057 = param3;
         this._navigator = param1;
         this.var_2241 = param2.navigateable;
         this._localization = param2.localization;
         this._pageId = param2.pageId;
         this._color = const_1284[param2.color];
         this.var_681 = param2.icon;
         this.var_1566 = param2.disabled;
         this._children = [];
      }
      ...
      protected function get iconName() : String
      {
         ...
         return ICON_PREFIX + this.var_681.toString();
      }
   }
}
