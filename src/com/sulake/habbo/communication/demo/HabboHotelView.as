package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1025:Function;
      
      private var var_1024:Function;
      
      private var var_669:IAssetLibrary;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_669.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_28,this.hotelViewLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_45,this.hotelViewLoadedHandler);
         }
         else
         {
            this.var_1024 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_28,this.hotelViewLoadedCallbackHandler);
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_669.getAssetByName(_loc2_.assetName);
         if(param1.type == AssetLoaderEvent.const_28)
         {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_28,this.hotelViewLoadedHandler);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_28)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_582));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this._window && !this._window.disposed)
            {
            ...
            {
               this.var_1024(_loc4_);
               this.var_1024 = null;
            }
         }
         _loc2_.removeEventListener(AssetLoaderEvent.const_28,this.hotelViewLoadedCallbackHandler);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_669.loadAssetFromFile("hotel_view_banner_" + this.var_1023,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_28,this.bannerLoadedHandler);
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_750));
            }
            this.var_1025 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_28,this.bannerLoadedCallbackHandler);
      ...
      private function bannerLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_28,this.bannerLoadedHandler);
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_28)
         {
            ...
            {
               this.var_1025(_loc4_);
               this.var_1025 = null;
            }
         }
         _loc2_.removeEventListener(AssetLoaderEvent.const_28,this.bannerLoadedCallbackHandler);
