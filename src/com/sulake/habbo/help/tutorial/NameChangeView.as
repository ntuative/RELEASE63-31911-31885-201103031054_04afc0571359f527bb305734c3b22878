package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1272:uint = 13232628;
      
      private static var var_1543:uint = 11129827;
      ...
      private var var_1542:IWindowContainer;
      ...
      private var var_1014:NameSuggestionListRenderer;
      ...
      {
         return TutorialUI.const_283;
      }
      
      public function set checkedName(param1:String) : void
      {
         this.var_455 = param1;
         if(this.var_1544 == this.var_455)
         {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1542 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_663)
         {
            this.var_663 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_663)
            {
               return;
            }
            this._window.content.addChild(this.var_663);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_664)
         {
            this.var_664 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_664)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_664.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_792:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_794:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_989 || param1 == ChangeUserNameResultMessageEvent.var_990)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1014 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1014.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1272;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_84);
         }
      }
