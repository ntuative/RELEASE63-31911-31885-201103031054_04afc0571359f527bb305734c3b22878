package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_283:String = "TUI_NAME_VIEW";
      
      public static const const_334:String = "TUI_CLOTHES_VIEW";
      
      public static const const_578:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_543,this.onTaskDoneEvent);
         this.var_34.events.addEventListener(HabboHelpTutorialEvent.const_446,this.onTaskDoneEvent);
         ...
         {
            this.var_34.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_291,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1074 && this.var_1075 && this.var_1333;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_34)
         {
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_543,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_446,this.onTaskDoneEvent);
            this.var_34.events.removeEventListener(HabboHelpTutorialEvent.const_463,this.onTaskDoneEvent);
            if(this.var_34.sessionDataManager != null)
            {
               this.var_34.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_291,this.onFigureUpdate);
            }
            this.var_34 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_42 == null || this.var_42.id == const_84)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_543:
               this.var_1333 = true;
               if(this.var_42 != null && this.var_42.id == const_578)
               {
                  this.showView(const_84);
               }
               break;
            case HabboHelpTutorialEvent.const_446:
               if(this.var_42 != null && this.var_42.id == const_334)
               {
                  this.var_1653 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2007 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2006;
         this._window.width = _loc2_.width + this.var_2007;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_34.hideUI();
         this.var_34.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_113));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_42 != null && (this.var_42.id == const_283 || this.var_42.id == const_84))
         {
            this.showView(const_84);
         }
      }
      ...
      {
         this.var_1074 = true;
         if(this.var_42 != null && (this.var_42.id == const_334 || this.var_42.id == const_84))
         {
            this.showView(const_84);
         }
      }
