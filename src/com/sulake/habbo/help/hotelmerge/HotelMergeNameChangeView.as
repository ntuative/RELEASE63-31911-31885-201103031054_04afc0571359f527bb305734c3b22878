package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_663)
         {
            this.var_663 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_663)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_664)
         {
            this.var_664 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_664)
            {
               return;
            }
