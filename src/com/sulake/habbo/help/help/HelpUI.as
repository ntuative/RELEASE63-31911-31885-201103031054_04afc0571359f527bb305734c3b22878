package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_319 = this._defaultViewId;
         this.var_449 = new Array();
         this.var_536 = new Array();
         super();
         this._component = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103031050));
         this.var_179 = param5;
         this.var_106 = new Map();
         this.var_106.add(HabboHelpViewEnum.const_1531,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_196,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_457,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_324,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_230,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_375,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_712,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_241,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_106.add(HabboHelpViewEnum.const_1148,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_106.add(HabboHelpViewEnum.const_1169,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_106.add(HabboHelpViewEnum.const_647,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_106.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_106.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_449.length == 0 || param1 != this.var_319)
            {
               this.var_449.push(this.var_319);
            }
         }
         this.var_319 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_319);
            return;
         }
         ...
         if(_loc3_)
         {
            ...
            {
               this.var_179.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.HELP,this._window));
            }
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_241:
               this.showUI(HabboHelpViewEnum.const_241);
               break;
            case CallForHelpResultEnum.const_1102:
               this.showUI(HabboHelpViewEnum.const_1169);
               break;
            case CallForHelpResultEnum.const_1177:
               this.showUI(HabboHelpViewEnum.const_1148);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_106.getValue(HabboHelpViewEnum.const_196) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_543));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_106.length)
         {
            _loc3_ = this.var_106.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_106.getValue(this.var_319);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2007 = this._window.width - _loc4_.width;
         this.var_2006 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2006;
         this._window.width = _loc1_.width + this.var_2007;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_449.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_319 == HabboHelpViewEnum.const_196)
         {
            return;
         }
         if(this.var_536.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_536.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_536.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_318.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_536[1],this.var_536[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_536[0],this.var_536[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_319 == HabboHelpViewEnum.const_196 || this.var_449.length == 0)
         {
            return;
         }
         if(this.var_318 == null)
         {
            ...
            this.var_318 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_318.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_318.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_318 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_318 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_318 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
