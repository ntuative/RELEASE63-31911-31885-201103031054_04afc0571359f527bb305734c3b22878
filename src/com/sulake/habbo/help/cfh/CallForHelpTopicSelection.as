package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1307:int = 0;
      
      private static const const_415:int = 1;
      ...
      override public function render() : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            if(_loc7_ != 0)
            {
               this.var_729.push(_loc7_);
            }
         }
         _loc6_ = 0;
         while(_loc6_ < this.var_729.length)
         {
            _loc8_ = this.var_729[_loc6_];
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(this.var_729 == null || _loc3_ < 0 || _loc3_ >= this.var_729.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = this.var_729[_loc3_];
            main.showUI(HabboHelpViewEnum.const_712);
            main.tellUI(HabboHelpViewEnum.const_712,null);
         }
      }
   }
}
