package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_501:String = "LEFT";
      
      private var var_156:Number = 50;
      
      private var var_1151:Boolean = true;
      
      private var var_1152:Number = 1;
      
      private var var_1422:Number = 0;
      
      private var var_1809:Number = 15;
      
      private var var_1810:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2793 = new Array();
         ...
         this.var_215 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_61,HabboWindowStyle.const_1206,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1151 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1151)
         {
            this._window.addEventListener(WindowMouseEvent.const_44,this.onToolbarMouseDown);
         ...
         this.var_1152 = _loc6_.toolbar.@margin_top;
         this.var_1422 = _loc6_.toolbar.@margin_bottom;
         this.var_1809 = _loc6_.toolbar.@min_group_margin;
         this.var_1810 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_280 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_255,param1,param2,this._window,this.var_280);
         this.createGroupsFromXmlList(_loc8_,this.var_612,param1,param2,this.var_215,this.var_280);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_156,this.var_501,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_501);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_156,this.var_501);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_156,this.var_501);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_612.length)
         {
            _loc2_ = this.var_612[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_215.x = this.var_156 + this.var_1810;
               this.var_215.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_215.x = 0;
               this.var_215.y = this.var_156 + this.var_1810;
         ...
         _loc4_ -= this.var_1422;
         _loc4_ -= this.var_1152;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1152;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_255.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1809,(this._window.height - _loc5_ * _loc8_ - this.var_1152 - this.var_1422) / (this.var_255.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1809,(this._window.width - _loc5_ * _loc8_ - this.var_1152 - this.var_1422) / (this.var_255.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_255.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_501;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_612.length)
         {
            _loc3_ = this.var_612[_loc2_];
            if(_loc3_ != null)
            {
