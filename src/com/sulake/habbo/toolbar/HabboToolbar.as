package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1357:LogoutController;
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1357 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_1141,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_138,this.onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_99,this.onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_52,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_481,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1027,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1146,this.method_11);
         this._state = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_70));
      }
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         ...
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_52)
            {
      ...
      private function method_11(param1:HabboToolbarShowMenuEvent) : void
      {
         if(this._state && this._view != null)
         {
