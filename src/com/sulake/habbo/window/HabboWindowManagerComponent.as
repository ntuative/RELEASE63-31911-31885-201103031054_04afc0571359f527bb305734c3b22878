package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_413:uint = 3;
      
      private static const const_1252:uint = 1;
      ...
      private var var_839:IWindowRenderer;
      
      private var var_827:ISkinContainer;
      
      private var var_327:Array;
      
      private var var_1287:IEventDispatcher;
      
      private var var_1029:Boolean = false;
      
      private var var_1571:ProfilerOutput;
      
      private var var_1288:ProfilerAgentTask;
      
      private var var_1289:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_827 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_839 = new WindowRenderer(this.var_827);
         this.var_186 = new Array(const_413);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_413)
         {
            this.var_186[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_839,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_186[const_1252];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_340,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1506,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1571)
            {
               this.var_1571 = new ProfilerOutput(context,this,this.var_839);
            }
            this.var_1571.profiler = _loc3_;
            this.var_1288 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1288);
            this.var_1289 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1289);
            this.var_1029 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_186)
            {
               ...
               {
                  IDisposable(this.var_186.pop()).dispose();
               }
            }
            this.var_186 = null;
            if(this.var_327)
      ...
      {
         var _loc3_:Dictionary = this.var_327[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_327[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_827.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_186[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_186[param2].getDesktopWindow();
      ...
      {
         return this.var_186[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_186[param1].getDesktopWindow().getChildAt(this._windowContext.getDesktopWindow().numChildren - 1);
      }
      
      public function getWindowContext(param1:uint) : IWindowContext
      {
         return this.var_186[param1];
      }
      
      public function getDesktop(param1:uint) : IDesktopWindow
      {
         var _loc2_:IWindowContext = this.var_186[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_374.length > 0)
         {
            this.var_1287.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_413 - 1;
            while(_loc2_ >= 0)
            {
               this.var_186[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1029)
         ...
         this.var_1287.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_413)
         {
            this.var_186[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1029)
         {
         ...
         if(WindowContext.var_374.length > 0)
         {
            WindowContext.var_374.flush();
         }
         this.var_1287.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1627,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1608,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1519,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_496,
            "style":WindowStyle.const_199,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
