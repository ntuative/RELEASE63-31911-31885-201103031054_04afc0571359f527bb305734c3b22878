package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_1042:String = "RS_CONNECTED";
      
      public static const const_1065:String = "RS_READY";
      
      public static const const_874:String = "RS_DISCONNECTED";
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:int = var_22;
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1042);
         }
      }
      ...
      private function onFlatAccessible(param1:FlatAccessibleMessageEvent) : void
      {
         ...
         else if(listener && false)
         {
            ...
            if(_loc6_ != null)
            {
               listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_46,_loc6_,_loc5_));
            }
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            ...
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_1065);
         }
      }
      ...
      private function onFlatAccessDenied(param1:FlatAccessDeniedMessageEvent) : void
      {
         ...
         if(_loc5_ == null || _loc5_.length == 0)
         {
            if(listener)
            {
               listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_874);
            }
         }
         else if(listener && false)
         {
            ...
            if(_loc6_ != null)
            {
               listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_139,_loc6_,_loc5_));
            }
         }
      }
