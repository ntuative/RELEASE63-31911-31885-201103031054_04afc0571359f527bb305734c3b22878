package com.sulake.habbo.session.handler
{
   ...
   public class ViralFurniHandler extends BaseHandler
   {
      ...
      private function onViralFurniStatus(param1:IMessageEvent) : void
      {
         ...
         var _loc6_:IRoomSession = listener.getSession(_xxxRoomId,var_22);
         if(_loc6_ == null)
         {
            return;
         }
         var _loc7_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_467,_loc6_);
      ...
      private function onViralGiftReceived(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:RoomSessionViralFurniStatusEvent = new RoomSessionViralFurniStatusEvent(RoomSessionViralFurniStatusEvent.const_443,_loc4_);
