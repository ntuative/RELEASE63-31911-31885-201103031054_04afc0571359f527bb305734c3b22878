package com.sulake.habbo.session.handler
{
   ...
   import com.sulake.habbo.communication.messages.incoming.quest.AvailableQuestBadgesMessageEvent;
   ...
   public class RoomUsersHandler extends BaseHandler
   {
      ...
      public function RoomUsersHandler(param1:IConnection, param2:IRoomHandlerListener)
      {
         ...
         param1.addMessageEvent(new AvailableQuestBadgesMessageEvent(this.onUserGivableBadges));
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:IRoomSession = listener.getSession(_xxxRoomId,var_22);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onUserRemove(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:IRoomSession = listener.getSession(_xxxRoomId,var_22);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function onUserGivableBadges(param1:IMessageEvent) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc2_:AvailableQuestBadgesMessageEvent = param1 as AvailableQuestBadgesMessageEvent;
         if(_loc2_ == null)
         {
            return;
         }
         var _loc3_:AvailableQuestBadgesMessageParser = _loc2_.getParser();
         if(!_loc3_)
         {
            return;
         }
         ...
         var _loc5_:* = [];
         for each(_loc6_ in _loc3_.badges)
         {
            _loc7_ = new GivableBadgeData(_loc6_.badgeId,_loc6_.achievementTypeName);
            _loc5_.push(_loc7_);
         }
         _loc4_.userDataManager.setUserGivableBadges(_loc5_);
         listener.events.dispatchEvent(new RoomSessionUserGivableBadgesEvent(_loc4_,_loc5_));
      }
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_111,_loc3_,_loc2_.userName));
      }
      ...
      {
         var _loc2_:IRoomSession = listener.getSession(_xxxRoomId,var_22);
         if(_loc2_ == null)
         {
            return;
         }
