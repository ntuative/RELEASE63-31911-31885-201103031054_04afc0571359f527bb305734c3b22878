package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1025:String = "group_badge";
      
      public static const const_1402:String = "normal_badge";
       
      
      private const const_1705:String = "badge_";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = this.const_1705 + param1;
         ...
         switch(param2)
         {
            case const_1402:
               ...
               {
                  _loc5_ = this.var_168.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1025:
               if(this.var_168 != null)
               {
                  if(this.var_168 != null)
                  {
                     _loc5_ = this.var_168.getKey("group.badge.url");
         ...
         if(_loc4_ != null)
         {
            ...
            _loc8_.addEventListener(AssetLoaderEvent.const_28,this.onBadgeImageReady);
         }
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_1705,"");
