package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1258:int = 10;
      
      private static const const_923:int = 100;
      
      private static const const_1257:int = 20;
       
      
      private var var_125:HabboMessenger;
      
      private var var_2152:IScrollbarWindow;
      
      private var var_1594:IContainerButtonWindow;
      
      private var var_59:IItemListWindow;
      
      private var var_465:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_125 = param1;
         this.var_1594 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_59 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2152 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_125.refreshButton(param2,"close",true,this.method_9,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_923 + const_1257)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_125.getButtonImage(param1);
      ...
      private function refreshListDims() : void
      {
         ...
         this.var_59.autoArrangeItems = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_59.numListItems)
         {
            _loc2_ = ITextWindow(this.var_59.getListItemAt(_loc1_));
      ...
      {
         param1.width = this.var_59.width;
         param1.height = param1.textHeight + const_1258;
         param1.invalidate();
      }
      ...
      private function findAddIndex() : int
      {
         ...
         while(_loc1_ < this.var_59.numListItems)
         {
            _loc2_ = this.var_59.getListItemAt(_loc1_);
            if(!_loc2_.visible)
            {
               return _loc1_;
            }
      ...
      {
         var _loc1_:Conversation = this.var_125.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(this.var_465 == null || _loc1_.id != this.var_465.id)
         {
            this.var_465 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_465.followingAllowed)
         {
            this.var_1594.enable();
         }
         else
         {
            this.var_1594.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_59.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_465.messages.length - const_923);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_465.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_465.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc4_:ITextWindow = this.var_59.getListItemAt(param2) as ITextWindow;
         if(_loc4_ == null)
         {
            if(!param1)
            {
            ...
            _loc4_ = ITextWindow(this.var_125.getXmlWindow("msg_entry"));
            _loc4_.width = this.var_59.width;
            this.var_59.addListItem(_loc4_);
         }
         if(!param1)
         {
            _loc4_.height = 0;
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_826 || param3.type == Message.const_635 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_465.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_125.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_125.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_125.send(new FollowFriendMessageComposer(this.var_465.id));
      }
      ...
      private function method_9(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_125.conversations.closeConversation();
         this.var_125.messengerView.refresh();
      }
      
      private function getChatBgColor(param1:int) : uint
      {
         if(param1 == Message.const_826)
         {
            return 4294967295;
         }
         if(param1 == Message.const_635)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1165)
         {
            return 4294927974;
         }
         if(param1 == Message.const_646)
         {
            return 4293454056;
         }
         if(param1 == Message.const_785)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1114)
         {
            return 4288269465;
         }
         return 4291611852;
