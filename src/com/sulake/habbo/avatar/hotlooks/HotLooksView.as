package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_65:HotLooksModel;
      
      private var var_622:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_622 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_622.numGridItems > 0)
         {
            this.var_622.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_65 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_622.removeGridItems();
         for each(_loc2_ in this.var_65.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_622.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_622.getGridItemIndex(param2.parent);
            this.var_65.selectHotLook(_loc3_);
         }
      }
