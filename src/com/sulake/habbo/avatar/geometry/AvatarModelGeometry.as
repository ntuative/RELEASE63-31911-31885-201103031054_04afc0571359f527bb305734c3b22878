package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1579:AvatarSet;
      
      private var var_678:Dictionary;
      
      private var var_1580:Dictionary;
      
      private var var_1034:Matrix4x4;
      
      private var var_851:Vector3D;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc15_:* = null;
         var _loc16_:* = null;
         this.var_851 = new Vector3D(0,0,10);
         super();
         this.var_1034 = new Matrix4x4();
         this.var_678 = new Dictionary();
         this.var_1580 = new Dictionary();
         this.var_1579 = new AvatarSet(param1.avatarset[0]);
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_851.x = _loc11_;
            this.var_851.y = _loc12_;
            this.var_851.z = _loc13_;
         }
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_678[String(_loc6_.@id)] = _loc7_;
            this.var_1580[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1579.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1579.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_157[param1];
         if(_loc3_ != null)
         {
      ...
      {
         return this.var_678[param1] != null;
      }
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = this.var_678[param1] as Dictionary;
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(this.typeExists(param1))
         {
            return this.var_678[param1] as Dictionary;
         }
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1580[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1034 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1034);
            _loc9_ = _loc7_.getDistance(this.var_851);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1034 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1034,this.var_851,param4);
         }
         return [];
      }
