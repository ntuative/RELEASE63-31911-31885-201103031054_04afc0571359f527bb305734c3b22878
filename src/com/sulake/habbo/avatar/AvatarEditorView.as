package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1225:IWindowContainer;
      
      public static var var_1486:IWindowContainer;
      
      public static var var_1966:int = 6710886;
      ...
      private var var_491:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_490:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1133 = [];
         this.var_1338 = [AvatarEditorFigureCategory.const_649,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_257,AvatarEditorFigureCategory.const_849,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_102];
         super();
         ...
         if(var_1225 == null)
         {
            ...
            var_1225 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1486 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1486 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_418 = new Timer(1000);
         this.var_418.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1338;
         }
         for each(_loc6_ in param4)
         {
            this.var_1133.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_418.stop();
            this.var_418.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_418 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1338);
         }
         if(param1.length != this.var_1133.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1133.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2429 = this.canChangeOutfit();
            this.var_418.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_491 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_491.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_491.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1133.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_491.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_491.numSelectables)
               {
                  this.var_491.getSelectableAt(_loc6_).x = this.var_491.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1338;
      ...
      public function update() : void
      {
         ...
         {
            _loc3_.visible = this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40) && this._controller.isWardrobeAllowed();
         }
         var _loc4_:String = "null";
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40) && (this.var_1755 == AvatarEditorSideCategory.const_102 || this.var_2428))
         {
         ...
         this.setViewToCategory(this.var_319);
      }
      ...
      {
         if(this.var_1755 == AvatarEditorSideCategory.const_102)
         {
            this.var_2428 = false;
            this.setSideContent(AvatarEditorSideCategory.const_848);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_102);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_848:
               break;
            case AvatarEditorSideCategory.const_517:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_517);
               break;
            case AvatarEditorSideCategory.const_102:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_102);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_319 = param1;
         this.var_491.setSelected(this.var_491.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_490)
         {
            ...
            this.var_490 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_490.procedure = this.stripClubDialogEventProc;
            this.var_490.center();
         }
         else
         {
