package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      private var var_643:Dictionary;
      
      public function SetType(param1:XML)
      {
         super();
         this._type = String(param1.@type);
         this.var_2735 = parseInt(param1.@paletteid);
         this.var_643 = new Dictionary();
         this.var_643["F"] = new Dictionary();
         this.var_643["M"] = new Dictionary();
         this.var_643["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_643["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_643["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_643["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_643[param1.toUpperCase()][Math.min(param2,1)];
      }
