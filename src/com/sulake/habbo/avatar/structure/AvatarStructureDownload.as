package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1101:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2316:IStructureData;
      ...
      public function AvatarStructureDownload(param1:IAssetLibrary, param2:String, param3:IStructureData)
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_28,this.onDataComplete);
      }
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1680 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2316.appendXML(this.var_1680);
         dispatchEvent(new Event(AvatarStructureDownload.const_1101));
      }
   }
}
