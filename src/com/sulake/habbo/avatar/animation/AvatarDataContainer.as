package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2638:uint;
      
      private var var_2637:uint;
      ...
      private var var_1686:Number = 1.0;
      ...
      private var var_1189:Map;
      
      private var var_2639:Boolean = true;
      
      public function AvatarDataContainer(param1:XML)
      {
         super();
         this.var_1882 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2638 = parseInt(_loc2_,16);
         this.var_2637 = parseInt(_loc3_,16);
         ...
         this.var_1552 = new ColorTransform(this.var_1686,this.var_1689,this.var_1690,this._alphaMultiplier);
         this.var_1189 = this.generatePaletteMapForGrayscale(this.var_2637,this.var_2638);
      }
      ...
      {
         return this.var_1189.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1189.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1189.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1189.getValue("alphas") as Array;
      }
