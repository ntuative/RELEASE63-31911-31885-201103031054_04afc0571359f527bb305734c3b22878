package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1808:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_131 = new Dictionary();
         this.var_1808 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2527 = parseInt(param1.@precedence);
         this.var_2522 = String(param1.@activepartset);
         this.var_2526 = String(param1.@assetpartdefinition);
         this.var_2528 = String(param1.@lay);
         this.var_746 = String(param1.@geometrytype);
         this.var_2439 = Boolean(parseInt(param1.@main));
         this.var_2525 = Boolean(parseInt(param1.@name_5));
         this.var_2523 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2524 = _loc6_;
            }
            else
            {
               this.var_1808[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_131[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_755 = new Map();
         }
         if(this.var_755.getValue(param1) == null)
         {
            this.var_755.add(param1,new Map());
         }
         var _loc4_:Map = this.var_755.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_755.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1808[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2524;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_131[param1];
         if(_loc2_ != null)
         {
