package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements ISideContentModel
   {
      ...
      private function init() : void
      {
         ...
         if(this.var_507)
         {
            for each(_loc2_ in this.var_507)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
         ...
         while(_loc1_ <= 10)
         {
            this.var_507.add(_loc1_,new WardrobeSlot(this._controller,_loc1_,this.method_8(_loc1_)));
            _loc1_++;
         }
         if(this._view)
         {
      ...
      public function updateSlots(param1:int, param2:Array) : void
      {
         ...
         {
            _loc3_ = this.var_507.getValue(_loc4_.slotId) as WardrobeSlot;
            if(_loc3_)
            {
               _loc3_.update(_loc4_.figureString,_loc4_.gender,this.method_8(_loc3_.id));
            }
         }
      }
      
      private function method_8(param1:int) : Boolean
      {
         if(param1 <= 5)
         {
            return this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_40);
         }
         return this._controller.sessionData.hasUserRight("fuse_larger_wardrobe",HabboClubLevelEnum.const_43);
      }
      
      public function get slots() : Array
      {
         return this.var_507.getValues();
      }
   }
}
