   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_201,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.const_216,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_65 && var_136 == "")
         {
            var_65.switchCategory(FigureData.const_201);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_jacket":
                  ...
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_201);
                  break;
