   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_37)
         {
            ...
            var_37["null"] = new AvatarEditorGridView(var_65,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_65.controller.gender)
         {
            case FigureData.const_79:
               activateTab(this.const_609);
               inactivateTab(this.const_610);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_610);
               inactivateTab(this.const_609);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_609:
                  var_65.controller.gender = FigureData.const_79;
                  param1.stopPropagation();
                  break;
               case this.const_610:
                  var_65.controller.gender = FigureData.FEMALE;
                  param1.stopPropagation();
            }
         }
