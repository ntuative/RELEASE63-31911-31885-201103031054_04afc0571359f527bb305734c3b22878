package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1287:String = "Default";
      
      private static const const_1288:int = 2;
      
      private static const const_1286:String = AvatarSetType.const_34;
      ...
      protected var var_1984:int;
      
      protected var var_267:IActiveActionData;
      
      protected var var_657:Boolean;
      
      protected var var_755:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_253:AvatarImageCache;
      
      protected var var_615:AvatarFigureContainer;
      
      protected var var_527:IAvatarDataContainer;
      ...
      protected var var_1232:Boolean = false;
      ...
      private var var_2243:String = null;
      
      private var var_2244:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_615 = param3;
         this.var_253 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1286,const_1288);
         this.var_314 = new Array();
         this.var_912 = new ActiveActionData(AvatarAction.const_335);
         this.var_912.definition = this._structure.getActionDefinition(const_1287);
         this.resetActions();
      ...
      public function dispose() : void
      {
         ...
         if(!this.var_657)
         {
            ...
            if(this.var_712)
            {
               for each(_loc2_ in this.var_712)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return this._structure.getPartColor(this.var_615,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1640;
         if(param2 < AvatarDirectionAngle.const_980)
         {
            param2 = AvatarDirectionAngle.const_277 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_277)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_50 || param1 == AvatarSetType.const_34)
         {
            if(param1 == AvatarSetType.const_50 && this.isHeadTurnPreventedByAction())
            {
               param2 = this.var_88;
            }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_237.length == 1 && this.var_88 == this.var_1984)
         {
            return this.var_88 + this.var_477 + this.var_581 % 4;
         }
      ...
      {
         if(param3 != this.var_2245 || param2 != this.var_2243 || param1 != this.var_2244)
         {
            this.var_2245 = param3;
            this.var_2243 = param2;
            this.var_2244 = param1;
            this.var_1639 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1232 || this.var_44 == null || (this.var_44.width != _loc5_.width || this.var_44.height != _loc5_.height))
         {
            if(this.var_44 != null && !this.var_1232)
            {
               this.var_44.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_267.definition.geometryType,this.var_88);
         this.var_44.lock();
         ...
         {
            if(this.var_527.paletteIsGrayscale)
            {
               ...
               this.var_44 = _loc13_;
               this.var_44.paletteMap(this.var_44,this.var_44.rect,new Point(0,0),this.var_527.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_267.definition.geometryType,this.var_88);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_314.push(new ActiveActionData(param1,param2,this.var_581));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_267 = this.var_912;
         this.var_267.definition = this.var_912.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_477 = "";
         this.var_237 = this._structure.sortActions(this.var_314);
         if(this.var_237 == null)
         {
            this.var_755 = new Array(0,0,0);
            if(this.var_1324 != "")
            {
               _loc1_ = true;
               this.var_1324 = "";
         ...
         {
            this.var_755 = this._structure.getCanvasOffsets(this.var_237,this._scale,this.var_88);
            for each(_loc4_ in this.var_237)
            {
               this.var_477 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_289)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1325 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1325 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1324 != this.var_477)
            {
               _loc1_ = true;
               this.var_1324 = this.var_477;
            }
         }
         this.var_1326 = true;
         return _loc1_;
         ...
         for each(_loc1_ in this.var_237)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_189 = this.var_189.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1640 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_527 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_308 || _loc1_.actionType == AvatarAction.const_245 || _loc1_.actionType == AvatarAction.const_382)
               {
                  this.var_911 = true;
               }
            }
