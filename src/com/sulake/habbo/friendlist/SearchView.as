package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_710:ITextFieldWindow;
      ...
      {
         this.var_710 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_710.procedure = this.onSearchInput;
         this.var_710.addEventListener(WindowKeyboardEvent.const_202,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_59.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_406,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = this.var_59.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
            ...
            this.var_59.addListItem(_loc10_);
         }
         if(param1)
         {
            _loc10_.height = 20;
      ...
      private function onSearchEntry(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_380.setData(_loc3_.isAvatarOnline,_loc3_.avatarName,_loc3_.avatarMotto,_loc3_.avatarFigure,_loc3_.lastOnlineDate,_loc3_.realName);
            this.var_380.showPopup(this._friendList.view.mainWindow,IWindowContainer(param2));
         }
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(this.var_59.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         {
            _loc5_ = 25;
            _loc6_ = this.var_710.text;
            if(_loc6_.length > _loc5_)
            {
               this.var_710.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_710.text;
