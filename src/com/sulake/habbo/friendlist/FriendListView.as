package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1714:String = "noconvinfo";
      
      private static const const_1713:String = "messageinput";
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1470 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_52,HabboToolbarIconEnum.FRIENDLIST,this.var_16));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_903 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_263 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1470.prepare(this.var_903);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_988,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1115,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_738,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_891,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_738,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_891,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1469 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1469.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1916 == -1 ? 0 : int(this.var_16.height - this.var_1916);
         var _loc4_:int = this.var_1917 == -1 ? 0 : int(this.var_16.width - this.var_1917);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_263.y = Util.getLowestPoint(this.var_16.content);
         this.var_263.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1034,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_738,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_988,false);
         ...
         this.var_1916 = this.var_16.height;
         this.var_1917 = this.var_16.width;
