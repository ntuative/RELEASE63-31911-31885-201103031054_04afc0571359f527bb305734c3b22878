package com.sulake.habbo.friendlist
{
   ...
   public class AvatarPopupCtrl extends PopupCtrl
   {
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1778 != "")
         {
            friendList.refreshText(param1,"name_text_online",this.var_747,this.var_1778);
         }
         else
         {
            friendList.refreshText(param1,"name_text_online",this.var_747,this.var_1777);
         }
         friendList.refreshText(param1,"name_text_offline",!this.var_747,this.var_1777);
         friendList.refreshText(param1,"motto_text",this.var_747,this.var_2162);
         friendList.refreshButton(param1,"offline",!this.var_747,null,0);
         if(this.var_747)
         {
            this.refreshFigure(param1,this.var_2166);
