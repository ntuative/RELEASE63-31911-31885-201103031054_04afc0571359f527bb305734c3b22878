package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1907:int = "F".charCodeAt(0);
      
      public static const const_1816:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_953 = param1.gender;
         this.var_747 = param1.online;
         this.var_1677 = param1.followingAllowed && param1.online;
         this.var_615 = param1.figure;
         this.var_1902 = param1.motto;
         this.var_1779 = param1.lastAccess;
         this.var_1269 = param1.categoryId;
         this.var_1778 = param1.realName;
