package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_403:int = 100;
      
      public static const const_1069:int = 0;
      ...
      {
         var _loc4_:* = null;
         if(this.var_205.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_205[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_205.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_205)
         {
      ...
      public function method_6(param1:int) : Friend
      {
         var _loc2_:Friend = this.getFriend(param1);
         if(_loc2_ != null)
         {
            Util.remove(this.var_205,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_879 >= this.getPageCount())
         {
            this.var_879 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_205.length / const_403);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_879 * const_403;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_879 + 1) * const_403,this.var_205.length);
      }
