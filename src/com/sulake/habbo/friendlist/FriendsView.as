package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_850:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2313:IContainerButtonWindow;
      
      private var var_2310:IContainerButtonWindow;
      
      private var var_2311:IContainerButtonWindow;
      
      private var var_2312:IContainerButtonWindow;
      
      private var var_59:IItemListWindow;
      
      private var var_380:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_380 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2313 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2310 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2311 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2312 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_96).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_59.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
            ...
            this.var_59.addListItem(_loc6_);
         }
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_850);
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_96,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_850);
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_96,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2313,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2310,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2311,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2312,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_380.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_380.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_380.closePopup();
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_96,param4);
         _loc6_.visible = true;
      }
