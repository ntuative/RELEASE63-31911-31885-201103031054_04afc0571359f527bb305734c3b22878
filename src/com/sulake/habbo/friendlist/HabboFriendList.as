package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_167:String = "face";
      ...
      private var var_125:IHabboMessenger;
      
      private var var_168:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1147:IAvatarRenderManager;
      
      private var var_754:ISessionDataManager;
      
      private var var_2521:FriendListLookAndFeel;
      
      private var var_426:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1806:OpenedToWebPopup;
      
      private var var_2163:int;
      
      var var_96:FriendCategories;
      
      private var var_357:FriendRequests;
      
      private var var_1807:AvatarSearchResults;
      ...
      {
         this.var_2521 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_96 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1807 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_611.stop();
            this.var_611.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_611 = null;
         }
         ...
         if(this.var_125)
         {
            this.var_125.release(new IIDHabboMessenger());
            this.var_125 = null;
         }
         if(this.var_168)
         {
         ...
         if(this.var_1147)
         {
            this.var_1147.release(new IIDAvatarRenderManager());
            this.var_1147 = null;
         }
         if(this.var_897)
         {
         ...
         if(this.var_754)
         {
            this.var_754.release(new IIDSessionDataManager());
            this.var_754 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1806 = new OpenedToWebPopup(this);
         }
         this.var_1806.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_96.findFriend(param1);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_96);
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_96.getFriendCount(param1,param2);
      }
      
      public function refreshToolBarIcon() : void
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_99,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_357.getCountOfOpenRequests() > 0 ? "2" : "0");
         this.var_179.events.dispatchEvent(_loc1_);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_327,HabboWindowStyle.const_41,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1147.createAvatarImage(param1,AvatarScaleType.const_92,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_50);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      {
         var _loc1_:String = this.var_168.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_168.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_125 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1147 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_897 = param2 as IHabboNotifications;
      ...
      {
         this.var_754 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_357 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_96.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_96.addCategory(new FriendCategory(FriendCategory.const_1069,this.getText("friendlist.friends")));
         this.var_96.addCategory(new FriendCategory(FriendCategory.const_343,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_96.addFriend(new Friend(_loc4_));
         }
         this.var_426 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_611)
         {
            this.var_611 = new Timer(120000);
            this.var_611.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_611.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_179.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_120,HabboToolbarIconEnum.FRIENDLIST));
         this.var_179.events.addEventListener(HabboToolbarEvent.const_37,this.onHabboToolbarEvent);
         if(this.var_96.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_96.findCategory(FriendCategory.const_343);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_426.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_407));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_96:
                     this.trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_406:
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_357.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_357.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_426.findTab(FriendListTab.const_100).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_357.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_426.findTab(FriendListTab.const_100);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1807.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_96.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_96.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_426.findTab(FriendListTab.const_100);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_754 || !this.var_357)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_754.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_357.vipLimit;
         }
         else if(this.var_754.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_40))
         {
            _loc2_ = this.var_357.clubLimit;
         }
         if(_loc2_ > this.var_357.limit)
         {
            this.var_357.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.var_96.getAllFriends();
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_167) as IBitmapWrapperWindow;
