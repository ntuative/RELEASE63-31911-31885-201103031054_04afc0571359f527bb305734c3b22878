package com.sulake.habbo.friendlist
{
   ...
   public class RoomInviteView extends AlertView
   {
      ...
      public function RoomInviteView(param1:HabboFriendList)
      {
         ...
         this.var_197 = param1.categories.getSelectedFriends();
      }
      ...
      {
         friendList.registerParameter("friendlist.invite.summary","count","" + this.var_197.length);
         this.var_865 = ITextFieldWindow(param1.findChildByName("message_input"));
      ...
      private function sendMsg() : void
      {
         ...
         for each(_loc3_ in this.var_197)
         {
