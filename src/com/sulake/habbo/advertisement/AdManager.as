package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1119:BitmapData = null;
      
      private var var_1118:BitmapData = null;
      ...
      {
         this.var_277 = param2 as IHabboCommunicationManager;
         if(this.var_277 == null)
         {
            return;
         }
         this._connection = this.var_277.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2402 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2399 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2400 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1732 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_211 != null && this.var_211.running)
         {
            this.var_211.reset();
            return false;
         }
         if(this.var_1120 == 0)
         {
            this.var_1120 = getTimer();
            return false;
         }
         if(this.var_1732 > 0 && this.var_1731 >= this.var_1732)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1120;
         if(_loc1_ > this.var_2399)
         {
            ++this.var_1731;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1391 = _loc2_.imageUrl;
         this.var_2401 = _loc2_.clickUrl;
         this.var_1120 = getTimer();
         if(this.var_1391 != "")
         {
            _loc3_ = this.var_1391;
            ...
            {
               this.var_211 = new Timer(this.var_2400,1);
               this.var_211.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_211.running)
            {
               this.var_211.reset();
            }
            this.var_211.start();
            _loc4_ = new URLRequest(this.var_1391);
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_45,this.interstitialLoaderEventHandler);
         }
         else
         {
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_439,0,0,param1.bitmapData,this.var_2401));
            this.var_1120 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_461));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1392 = _loc2_.imageUrl;
         this.var_1733 = _loc2_.clickUrl;
         if(this.var_1392 != "" && this.var_1733 != "")
         {
            _loc3_ = this.var_1392;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1392);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_577,0,0,_loc4_,this.var_1733,this.var_1119,this.var_1118));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1119 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1118 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
