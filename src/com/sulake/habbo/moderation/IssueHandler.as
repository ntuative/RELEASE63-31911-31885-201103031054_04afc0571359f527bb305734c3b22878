package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_162:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_521:UserInfoCtrl;
      
      private var var_1210:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(this.var_64.windowManager == null || this.var_64.assets == null)
         {
            return;
         }
         var _loc1_:XmlAsset = this.var_64.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         this._window = this.var_64.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._window == null)
         {
            return;
         }
         ...
         this.var_64.disableButton(this.var_64.initMsg.chatlogsPermission,this._window,"show_chatlog");
         _loc2_ = this._window.findChildByName("move_to_player_support");
         if(_loc2_ != null)
         {
            _loc2_.disable();
         }
         var _loc3_:IssueMessageData = this.var_162.getHighestPriorityIssue();
         this.var_521 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_1210 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
         this.var_521.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_162.reportedUserId > 0)
         {
            this.var_1210.load(_loc4_,this.var_162.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_162.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_162.issues;
         var _loc3_:int = 0;
         var _loc5_:int = _loc1_.numListItems;
         var _loc6_:int = _loc2_.length;
         if(_loc5_ < _loc6_)
         {
            _loc9_ = this.var_64.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
            if(_loc9_ == null || _loc9_.content == null)
            {
               return;
            }
            _loc4_ = this.var_64.windowManager.buildFromXML(_loc9_.content as XML) as IWindowContainer;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      private function updateMessages() : void
      {
         ...
         if(_loc5_ < _loc6_)
         {
            _loc8_ = this.var_64.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
            if(_loc8_ == null || _loc8_.content == null)
            {
               return;
            }
            _loc4_ = this.var_64.windowManager.buildFromXML(_loc8_.content as XML) as ITextWindow;
            if(_loc4_ == null)
            {
               return;
            }
      ...
      {
         if(this.var_64 != null && this.var_64.issueManager != null && this.var_162 != null)
         {
            this.var_64.issueManager.removeHandler(this.var_162.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_162.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_162.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.closeBundle(this.var_162.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_64.issueManager.releaseBundle(this.var_162.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_162.getHighestPriorityIssue().issueId;
         this.var_64.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_64,WindowTracker.const_1000,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_162.getHighestPriorityIssue();
            this.var_521 = new UserInfoCtrl(this._window,this.var_64,_loc3_.message);
            this.var_521.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      {
         if(this._window == null || this.var_64 == null || this.var_64.issueManager == null)
         {
            return;
         }
         ...
         {
            this.var_64.issueManager.autoPick();
         }
      }
   }
}
