package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_965:Array = [];
      ...
      {
         this.var_763 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
         ...
         this.var_59 = IItemListWindow(this._frame.findChildByName("visits_list"));
      ...
      {
         return WindowTracker.const_1621;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_965.pop() as IWindowContainer;
         }
      ...
      {
         var _loc2_:IWindowContainer = IWindowContainer(this.var_59.parent);
         var _loc3_:IWindow = _loc2_.getChildByName("scroller") as IWindow;
         var _loc4_:* = this.var_59.scrollableRegion.height > this.var_59.height;
         if(_loc3_.visible)
         {
            if(!_loc4_)
            {
               _loc3_.visible = false;
               this.var_59.width += 17;
            }
         }
         else if(_loc4_)
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1444)
         {
