package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1000:int = 3;
      
      public static const const_742:int = 4;
      
      public static const const_997:int = 5;
      
      public static const const_1621:int = 6;
      ...
      {
         var _loc2_:Dictionary = this.var_1678[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1678[param1] = _loc2_;
         }
         return _loc2_;
      }
   }
