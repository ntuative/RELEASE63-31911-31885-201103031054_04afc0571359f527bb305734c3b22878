package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_930:int = 60;
      
      private static const const_932:int = 3600;
      
      private static const const_933:int = 86400;
      
      private static const const_931:int = 31536000;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_1054 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_930)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_932)
         {
            return Math.round(param1 / const_930) + " mins ago";
         }
         if(param1 < 2 * const_933)
         {
            return Math.round(param1 / const_932) + " hours ago";
         }
         if(param1 < 2 * const_931)
         {
            return Math.round(param1 / const_933) + " days ago";
         }
         return Math.round(param1 / const_931) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1053.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_34.getXmlWindow("user_info"));
            this.var_1053.addChild(_loc1_);
         ...
         _loc1_.findChildByName("modaction_but").procedure = this.method_10;
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_34,WindowTracker.const_997,this._data.userId),this._callerFrame,this.var_1054,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new RoomVisitsCtrl(this.var_34,this._data.userId),this._callerFrame,this.var_1054,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new SendMsgsCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1327),this._callerFrame,this.var_1054,false,true);
      }
      
      private function method_10(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type != WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            return;
         }
         this.var_34.windowTracker.show(new ModActionCtrl(this.var_34,this._data.userId,this._data.userName,this.var_1327),this._callerFrame,this.var_1054,false,true);
      }
