package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1064:IDropMenuWindow;
      ...
      private var var_1356:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_363));
         Logger.log("BEGINNING TO SHOW: " + this.var_363);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1596;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_363);
         if(param1.flatId != this.var_363)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_363);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      {
         this.var_59 = IItemListWindow(this._frame.findChildByName("list_cont"));
         ...
         this.var_1064 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1064);
         this.var_1064.procedure = this.onSelectTemplate;
         this.var_901 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1356 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1355 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_59.getListItemByName(param2));
         ...
         if(!param1.exists)
         {
            this.disposeItemFromList(this.var_59,_loc3_);
            this.disposeItemFromList(this.var_59,this.var_59.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_742,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_901.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1644,_loc2_,this.var_478.text,"",""));
         if(this.var_1356.isSelected || this.var_1355.isSelected || this.var_901.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1356.isSelected,this.var_1355.isSelected,this.var_901.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1415);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1405);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1064.selection];
         if(_loc3_ != null)
         {
            this.var_596 = false;
            this.var_478.text = _loc3_;
         }
      }
   }
}
