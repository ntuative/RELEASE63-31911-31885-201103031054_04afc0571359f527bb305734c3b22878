package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2009:String = "my_issues";
      
      private const const_2010:String = "open_issues";
      
      private const const_2011:String = "picked_issues";
      
      private const const_2017:String = "closed_issues";
      ...
      private var var_371:IIssueBrowserView;
      
      private var var_1928:IIssueBrowserView;
      
      private var var_1930:IIssueBrowserView;
      
      private var var_1929:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_264 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_264.numTabItems)
            {
               _loc5_ = this.var_264.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_264 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_264 == null || this.var_264.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_264.selector.getSelectableByName("open_issues");
         this.var_264.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_371 == _loc2_)
         {
            return;
         }
         if(this.var_371 != null)
         {
            this.var_371.visible = false;
         }
         this.var_371 = _loc2_;
         if(this.var_371 == null)
         {
         ...
         this.var_371.view.width = this.var_264.container.width;
         this.var_371.view.height = this.var_264.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2009:
               if(this.var_1928 == null)
               {
                  this.var_1928 = new MyIssuesView(this.issueManager,this,this.var_264.container);
               }
               return this.var_1928;
            case this.const_2010:
               if(this.var_1930 == null)
               {
                  this.var_1930 = new OpenIssuesView(this.issueManager,this,this.var_264.container);
               }
               return this.var_1930;
            case this.const_2011:
               if(this.var_1929 == null)
               {
                  this.var_1929 = new PickedIssuesView(this.issueManager,this,this.var_264.container);
               }
