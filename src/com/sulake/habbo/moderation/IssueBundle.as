package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_779:IssueMessageData = null;
      
      private var var_778:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2672 = param2.pickerUserId;
         this.var_2671 = param2.pickerUserName;
         this.var_1466 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1199 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1200;
         }
         if(this.var_779 == null || param1.timeStamp < this.var_779.timeStamp)
         {
            this.var_779 = param1;
         }
         if(this.var_778 == null || param1.priority > this.var_778.timeStamp)
         {
            this.var_778 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1199 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1200;
            }
            if(this.var_779 == _loc2_)
            {
               this.var_779 = null;
            }
            if(this.var_778 == _loc2_)
            {
               this.var_778 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_778;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_779;
         if(_loc2_ == null)
         {
