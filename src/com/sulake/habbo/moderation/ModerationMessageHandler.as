package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      {
         this.var_1085 = new Array();
         this.var_1086 = new Array();
         this.var_1087 = new Array();
         this.var_1084 = new Array();
      ...
      {
         if(param1 == null || this.var_64 == null)
         {
            return;
         }
         ...
         this.var_64.issueManager.playSound(_loc3_);
         this.var_64.issueManager.updateIssue(_loc3_);
      }
      ...
      private function onModeratorInit(param1:ModeratorInitMessageEvent) : void
      {
         ...
         {
            this.var_64.issueManager.updateIssue(_loc6_);
         }
         this.var_64.issueManager.updatePriorities();
         this.var_64.initMsg = _loc3_;
         this.var_64.startPanel.show();
      }
      ...
      private function onIssuePickFailed(param1:IssuePickFailedMessageEvent) : void
      {
         ...
         var pickedAlready:Boolean = this.var_64.issueManager.issuePickFailed(issues);
         if(pickedAlready)
         {
            if(retryEnabled)
            {
               ...
               {
                  alert = false;
                  this.var_64.issueManager.autoPick(retryEnabled,retryCount);
               }
            }
         }
         if(alert)
         {
            this.var_64.windowManager.alert("Error","Issue picking failed",0,function(param1:IAlertDialog, param2:Event):void
            {
               param1.dispose();
            });
         }
      ...
      private function onIssueDeleted(param1:IssueDeletedMessageEvent) : void
      {
         ...
         this.var_64.issueManager.removeIssue(_loc2_.issueId);
      }
      ...
      private function onUserInfo(param1:ModeratorUserInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1085)
         {
      ...
      private function onRoomInfo(param1:ModeratorRoomInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1084)
         {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         this.onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_1000,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         this.onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_742,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         this.onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_997,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      
      private function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         var _loc6_:* = null;
         for each(_loc6_ in this.var_1087)
         {
      ...
      private function onRoomVisits(param1:RoomVisitsEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1086)
         {
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         for each(_loc3_ in this.var_895)
         {
            _loc3_.onRoomChange();
         }
      }
      ...
      private function onModeratorActionResult(param1:ModeratorActionResultMessageEvent) : void
      {
         ...
         if(_loc2_.success)
         {
            this.var_64.connection.send(new GetModeratorUserInfoMessageComposer(_loc2_.userId));
         }
         else
         {
            this.var_64.windowManager.alert("Alert","Moderation action failed",0,this.onAlertClose);
         }
      }
      ...
      public function removeChatlogListener(param1:ChatlogCtrl) : void
      {
         var _loc3_:* = null;
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_1087)
         {
            if(_loc3_ != param1)
            {
               _loc2_.push(_loc3_);
