package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_870:int = 70;
      
      public static const const_425:int = 4;
      ...
      private static const const_419:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1888 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1888 = 15;
         }
         this.var_1889 = this._window.height;
         this.var_774 = 4;
         this.var_775 = 0;
         this._state = name_2;
         this.var_179 = param5;
      ...
      {
         if(param1.badgeId != this.var_216.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_487:
               ...
               _loc2_ = Number(this.var_1190) / Number(this.var_429["time_fade_in"]);
               if(this.var_1190 > int(this.var_429["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_968:
               ...
               if(this.var_1458 > int(this.var_429["time_display"]) && !this.var_1890)
               {
                  this.startFadeOut();
               }
               break;
            case const_967:
               ...
               _loc3_ = 1 - Number(this.var_1191) / Number(this.var_429["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1191 > int(this.var_429["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1888;
         if(this._window.height < this.var_1889)
         {
            this._window.height = this.var_1889;
         }
      }
      ...
      {
         this.var_1191 = 0;
         this._state = const_967;
      }
      
      private function startDisplay() : void
      {
         this.var_1458 = 0;
         this._state = const_968;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_179.orientation == "TOP" ? int(const_419) : 0;
         var _loc4_:int = this.var_179.orientation == "BOTTOM" ? int(_loc2_.height - const_419) : int(_loc2_.height);
         var _loc5_:int = this.var_179.orientation == "LEFT" ? int(const_419) : 0;
         var _loc6_:int = this.var_179.orientation == "RIGHT" ? int(_loc2_.width - const_419) : int(_loc2_.width);
         if(this.var_429["position_horizontal_follow_toolbar"] == "true" && (this.var_179.orientation != "TOP" && this.var_179.orientation != "BOTTOM"))
         {
            if(this.var_179.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_425;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_425;
            }
         }
         ...
         if(this.var_429["position_vertical_follow_toolbar"] == "true" && (this.var_179.orientation != "RIGHT" && this.var_179.orientation != "LEFT"))
         {
            if(this.var_179.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_774;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_774;
            }
         }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_775;
      }
   }
}
