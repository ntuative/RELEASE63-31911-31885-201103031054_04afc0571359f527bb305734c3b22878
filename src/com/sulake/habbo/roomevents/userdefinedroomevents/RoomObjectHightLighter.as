package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class RoomObjectHightLighter
   {
      ...
      {
         return this.var_78.roomEngine.getRoomObject(this.var_78.roomId,this.var_78.roomCategory,param1,RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE);
      }
