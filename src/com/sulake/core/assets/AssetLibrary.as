package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1220:String = "AssetLibraryReady";
      
      public static const const_863:String = "AssetLibraryLoaded";
      
      public static const const_1441:String = "AssetLibraryUnloaded";
      
      public static const const_1475:String = "AssetLibraryLoadError";
      ...
      private static var var_848:Array = new Array();
      ...
      private var var_677:XML;
      
      private var var_847:Boolean;
      
      private var var_390:uint;
      
      private var var_41:LibraryLoader;
      
      private var var_557:Class;
      ...
      private var var_391:Dictionary;
      
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_677 = new XML();
         this.var_390 = 0;
         ...
         ++var_461;
         this.var_391 = new Dictionary(false);
         this.var_462 = new Dictionary(false);
         this.var_846 = new Dictionary(false);
         this.var_142 = new Dictionary(false);
         var_848.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_848.splice(var_848.indexOf(this),1);
            --var_461;
            this.var_462 = null;
            this.var_846 = null;
            this.var_142 = null;
      ...
      {
         if(this._file == param1.url && this.var_847)
         {
            if(!this.var_849 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_677,this.var_557);
            }
            this.var_849 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1220));
         }
         else
         {
            if(this.var_41 == null || this.var_41.disposed)
            {
               this.var_41 = param1;
               this.var_41.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.libraryLoadedHandler);
               this.var_41.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.loadErrorHandler);
            }
            this.var_849 = param2;
            this._file = this.var_41.url;
         }
      }
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_142)
         {
            delete this.var_142[_loc1_];
         }
         for(_loc1_ in this.var_846)
         {
            delete this.var_846[_loc1_];
         }
         if(this.var_41 != null)
         {
            this.var_41.dispose();
         ...
         this.var_847 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1441));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_846[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         if(this.var_41 != null)
         {
            if(this.var_41.hasDefinition(param1))
            {
               _loc2_ = this.var_41.getDefinition(param1) as Class;
               if(_loc2_ != null)
               {
                  this.var_846[param1] = _loc2_;
                  return _loc2_;
               }
            }
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_45,this.assetLoadEventHandler);
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1054,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1124,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_142[struct.assetName] == null)
                  {
                     ++this.var_390;
                     this.var_392.push(struct.assetName);
                  }
                  this.var_142[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_45,e.status);
      ...
      {
         var _loc2_:IAsset = this.var_142[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_392.length ? this.getAssetByName(this.var_392[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_142)
         {
            if(this.var_142[_loc2_] == param1)
            {
               return this.var_392.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_142[param1] != null || (this.var_557 != null ? this.var_557[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_142[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            if(_loc4_)
            {
               ++this.var_390;
               this.var_392.push(param1);
            }
            this.var_142[param1] = param2;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_391.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_391[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_391[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_391)
         {
            _loc3_ = AssetTypeDeclaration(this.var_391[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_391)
         {
            _loc4_ = AssetTypeDeclaration(this.var_391[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_677 = _loc2_.manifest.copy();
         this.var_557 = _loc2_.resource;
         ...
         this.var_847 = true;
         dispatchEvent(new Event(AssetLibrary.const_863));
         dispatchEvent(new Event(AssetLibrary.const_1220));
         if(this.var_849)
         {
            this.var_41.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.libraryLoadedHandler);
            this.var_41.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.loadErrorHandler);
            this.var_41.addEventListener(LibraryLoader.LIBRARY_LOADER_FINALIZE,this.finalizeLoaderEventHandler);
            this.var_41 = null;
            this.var_557 = null;
         }
      }
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1475));
         this.var_41 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_677.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_557[param1]);
