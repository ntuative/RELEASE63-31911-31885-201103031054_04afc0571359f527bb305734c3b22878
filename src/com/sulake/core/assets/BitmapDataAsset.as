package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_535:uint = 0;
      
      protected static var var_508:uint = 0;
       
      
      private var _disposed:Boolean = false;
      
      private var var_104:Object;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_508 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_104 is Class)
         {
            _loc1_ = new this.var_104() as Bitmap;
            if(_loc1_ != null)
            {
            ...
            this._bitmap = new this.var_104() as BitmapData;
            if(this._bitmap != null)
            {
               this.var_104 = null;
               return;
         ...
         if(this.var_104 is Bitmap)
         {
            this._bitmap = Bitmap(this.var_104).bitmapData;
            if(this._bitmap == null)
            {
         ...
         if(this.var_104 is BitmapData)
         {
            this._bitmap = this.var_104 as BitmapData;
            if(this._bitmap != null)
            {
               this.var_104 = null;
               return;
         ...
         if(this.var_104 is BitmapDataAsset)
         {
            this._bitmap = BitmapDataAsset(this.var_104)._bitmap;
            this._offset = BitmapDataAsset(this.var_104)._offset;
            this.var_1435 = BitmapDataAsset(this.var_104).var_1435;
            this.var_1434 = BitmapDataAsset(this.var_104).var_1434;
            if(this._bitmap != null)
            {
               this.var_104 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1435 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1434 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
