package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      protected static const const_410:String = "_INTERNAL_EVENT_UNLOCKED";
      
      public static const COMPONENT_FLAG_NULL:uint = 0;
      
      public static const const_1851:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1212:uint = 4;
       
      
      protected var var_785:uint = 0;
      
      protected var var_1226:String = "";
      ...
      private var var_450:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_450 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_450.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_450.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1226 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1226);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1393 & const_1212)
         {
            if(_loc3_ == 0)
            {
               if(this.var_450.getTotalReferenceCount() == 0)
               {
      ...
      protected final function unlock() : void
      {
         ...
         {
            this.var_809 = false;
            this._events.dispatchEvent(new LockEvent(const_410,this));
         }
      }
      
      public function toString() : String
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_785 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_450.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_450.getStructByIndex(_loc8_);
