package com.sulake.core.runtime
{
   ...
   class Profiler extends Component implements IProfiler
   {
      ...
      {
         this.var_291 = new Dictionary(true);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            for(_loc1_ in this.var_291)
            {
               IDisposable(this.var_291[_loc1_]).dispose();
               delete this.var_291[_loc1_];
            }
            super.dispose();
         }
      }
      ...
      {
         this.var_2790 = getTimer() - this.var_2422;
      ...
      public function getProfilerAgentsInArray() : Array
      {
         ...
         for(_loc3_ in this.var_291)
         {
            ...
            {
               IDisposable(this.var_291[_loc3_]).dispose();
               delete this.var_291[_loc3_];
            }
            else
            {
               _loc1_.push(this.var_291[_loc3_]);
            }
         }
         return _loc1_;
      }
      ...
      {
         var _loc2_:ProfilerAgent = this.var_291[param1];
