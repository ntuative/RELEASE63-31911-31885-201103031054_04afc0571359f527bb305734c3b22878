package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1386:String = "float";
      
      public static const const_36:String = "Boolean";
      
      public static const const_1483:String = "bool";
      ...
      private static const const_952:String = "type";
      
      private static const const_603:String = "value";
      
      private static const const_593:String = "true";
      
      private static const const_1704:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         _loc7_ = param1.attribute(const_952);
         if(_loc7_.length() > 0)
         {
            _loc5_ = String(param1.attribute(const_952));
         }
         _loc7_ = param1.attribute(const_603);
         if(_loc7_.length() > 0)
         {
            _loc6_ = String(param1.attribute(const_603));
         }
         if(_loc6_ != null)
         {
         ...
         {
            _loc8_ = param1.child(const_603)[0];
            if(_loc8_ != null)
            {
            ...
            else if(_loc5_ == const_214 || _loc5_ == const_135)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1386:
               return Number(param1);
            case const_36:
               return param1 == const_593 || int(param1) > 0;
            case const_1483:
               return param1 == const_593 || int(param1) > 0;
            case const_149:
               return uint(param1);
            case const_135:
               return param1.split(const_1271);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_251:
               ...
               _loc5_.width = Number(param1.attribute(const_1270));
               _loc5_.height = Number(param1.attribute(const_1267));
               return _loc5_;
            case const_135:
               _loc3_ = new Map();
