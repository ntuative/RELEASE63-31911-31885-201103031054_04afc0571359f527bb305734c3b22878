package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1393:uint = 0;
      
      protected var var_271:Function;
      
      protected var var_1243:int;
      
      protected var var_1242:int;
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1243 *= 0.75;
         this.var_1242 *= 0.75;
         if(Math.abs(this.var_1243) <= 1 && Math.abs(this.var_1242) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_271 != null)
         {
            this.var_271(this.var_1243,this.var_1242);
         }
      }
