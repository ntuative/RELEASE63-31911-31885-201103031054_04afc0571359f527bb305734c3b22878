package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1388:uint = 0;
      
      public static const const_759:uint = 1;
      
      public static const const_994:uint = 2;
      
      public static const const_663:uint = 4;
      
      public static const const_1635:uint = 8;
      
      public static const const_1628:uint = 16;
      
      public static const const_1899:uint = 64;
      
      public static const const_1877:uint = 128;
      
      public static const const_1153:uint = 256;
      
      protected static var var_534:uint = 0;
      
      protected static var var_317:uint = 0;
       
      
      protected var var_200:DisplayObjectContainer;
      
      protected var var_1982:Boolean;
      
      protected var var_798:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_994:
               ...
               break;
            case GraphicContext.const_1635:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1628:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_663:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1153:
               break;
            case GraphicContext.const_1388:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_200.numChildren > 0)
               {
                  this.var_200.removeChildAt(0);
               }
            }
            this.var_200 = null;
            while(numChildren > 0)
         ...
         if(this.var_798)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_317 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1982,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1982,16777215);
                  }
                  var_317 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_798)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_317 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_200 == null)
         {
            this.var_200 = new Sprite();
            this.var_200.name = this.name + " - Child Container";
      ...
      {
         return this.var_200 != null ? int(this.var_200.numChildren) : 0;
      }
