package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1240 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_994,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_471)
         {
            this.focus();
         }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_364,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_804,false,PropertyStruct.const_36,true) : PropertyDefaults.const_1378);
         _loc1_.push(this.var_1241 != PropertyDefaults.const_1142 ? new PropertyStruct(PropertyDefaults.const_687,this.var_1241,PropertyStruct.const_36,true) : PropertyDefaults.const_1479);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1036 ? new PropertyStruct(PropertyDefaults.const_676,_field.selectable,PropertyStruct.const_36,true) : PropertyDefaults.const_1649);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1129 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_36,true) : PropertyDefaults.const_1513);
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_687:
                  this.var_1241 = _loc2_.value as Boolean;
                  if(this.var_1241)
                  {
                     _context.getWindowServices().getFocusManagerService().registerFocusWindow(this);
                  }
                  break;
               case PropertyDefaults.const_676:
               ...
               case PropertyDefaults.const_804:
                  ...
                  break;
               case PropertyDefaults.const_1112:
