package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_533 != PropertyDefaults.const_1077)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_889,this.var_533,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1422);
         }
         if(this.var_807 != PropertyDefaults.const_1009)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_854,this.var_807,PropertyStruct.const_53,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1507);
         }
         return _loc1_;
      }
