package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_411:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_171:DropMenuController;
      ...
      {
         if(param1 > this.var_242.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_465,this,null,true);
         this.update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_590 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_370,this,null));
         }
      }
      ...
      {
         if(this.var_171 != null && !this.var_171.disposed)
         {
            this.var_171.destroy();
            this.var_171 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_411) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_171 == null || this.var_171.disposed)
         {
            this.var_171 = context.create(name + "::submenu","",WindowType.const_572,var_81,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_171.setGlobalRectangle(_loc1_);
         }
         this.var_171.activate();
         return this.var_171;
      }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_242.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_902 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_171.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_902)
         {
            if(this.open())
            {
               if(this.var_242.length)
               {
                  this.populateMenuItemContainer(this.var_242,this.getSubMenu(),this.subMenuEventProc);
                  this.var_902 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_902 = false;
            this.getTitleLabel().text = this.var_590 < this.var_242.length && this.var_590 > -1 ? this.var_242[this.var_590] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_561,var_81,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_341,var_81,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_590 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_590).setStateFlag(WindowState.const_51,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_471)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1062:
            case WindowMouseEvent.const_59:
               ...
               break;
            case WindowTouchEvent.const_731:
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1210,this,null);
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_1178;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1204,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_1190;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_242.length)
            {
               _loc1_.push(this.var_242[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_242.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_644,this.var_242,PropertyStruct.const_135,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1369);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_644)
            {
