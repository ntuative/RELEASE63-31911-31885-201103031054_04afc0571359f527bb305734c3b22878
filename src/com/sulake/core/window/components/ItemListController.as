package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_105:Number;
      
      protected var var_92:Number;
      
      protected var _container:IWindowContainer;
      
      protected var var_1988:Boolean = false;
      
      protected var var_528:Boolean = false;
      
      protected var _spacing:int = 0;
      
      protected var _horizontal:Boolean = false;
      
      protected var var_2804:Number = 0.0;
      
      protected var var_2805:Number = 0.0;
      
      protected var var_996:Boolean = true;
      
      protected var var_443:Boolean = false;
      
      protected var var_1235:Boolean = false;
      
      protected var var_1989:int = 0;
      
      protected var var_1987:int = 0;
      
      protected var var_1234:Number;
      
      protected var var_1236:Number;
      
      protected var var_1233:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_105 = 0;
         this.var_92 = 0;
         this._horizontal = param2 == WindowType.const_388;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_165 = var_444 || !testParamFlag(WindowParam.const_32);
         this._container = _context.create("_CONTAINER","",WindowType.const_341,WindowStyle.const_730,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_49,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_475,this.containerEventHandler);
         ...
         this.resizeOnItemUpdate = this.var_1235;
      }
      ...
      {
         var _loc1_:int = this.var_105 - width;
      ...
      {
         return new Rectangle(this.var_648 * this.maxScrollH,this.var_647 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_648 = param1;
            this._container.x = -this.var_648 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_647 = param1;
            this._container.y = -this.var_647 * this.maxScrollV;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_69);
            dispatchEvent(new WindowEvent(WindowEvent.const_472,this,null));
         }
      }
      ...
      {
         this.var_2804 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2805 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_523,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_475,this.containerEventHandler);
      ...
      public function addListItem(param1:IWindow) : IWindow
      {
         ...
         if(this._horizontal)
         {
            param1.x = this.var_105 + (this.numListItems > 0 ? this._spacing : 0);
            this.var_105 = param1.rectangle.right;
            this._container.width = this.var_105;
         }
         else
         {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_44:
               this.var_1989 = _loc3_;
               this.var_1987 = _loc4_;
               this.var_1234 = 0;
               this.var_1236 = 0;
               this.var_1233 = true;
               _loc2_ = true;
            ...
            case WindowMouseEvent.const_180:
               if(this.var_1233)
               {
                  this.var_1234 = this.var_1989 - _loc3_;
                  this.var_1236 = this.var_1987 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1234 != 0 && this.var_105 != 0)
                     {
                        this.scrollH += this.var_1234 / this.var_105;
                     }
                  }
                  else if(this.var_1236 != 0 && this.var_92 != 0)
                  {
                     this.scrollV += this.var_1236 / this.var_92;
                  }
                  this.var_1989 = _loc3_;
                  this.var_1987 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_187:
               if(this.var_1233)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1234,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1236);
                  }
                  this.var_1233 = false;
                  _loc2_ = true;
               }
      ...
      private function scrollAnimationCallback(param1:int, param2:int) : void
      {
         if(!disposed)
         {
            this.scrollH -= param1 / this.var_105;
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_996 && !this.var_528 && this._container)
         {
            this.var_528 = true;
            ...
            if(this._horizontal)
            {
               ...
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     _loc2_.x = this.var_105;
                     this.var_105 += _loc2_.width + this._spacing;
                     if(this.var_443)
                     {
               ...
               if(_loc1_ > 0)
               {
                  this.var_105 -= this._spacing;
               }
            }
            else
            {
               this.var_105 = var_11.width;
               this.var_92 = 0;
               _loc4_ = 0;
               while(_loc4_ < _loc1_)
               {
                  ...
                  if(_loc2_.visible)
                  {
                     ...
                     if(this.var_443)
                     {
                        ...
                        this.var_105 = _loc3_ > this.var_105 ? Number(_loc3_) : Number(this.var_105);
                     }
                  }
                  _loc4_++;
               }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_342,this._spacing,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1172);
         }
         if(this.var_996 != PropertyDefaults.const_1060)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_698,this.var_996,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1470);
         }
         if(this.var_443 != PropertyDefaults.const_1205)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_896,this.var_443,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1636);
         }
         if(this.var_1235 != PropertyDefaults.const_1137)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_673,this.var_1235,PropertyStruct.const_36,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1446);
         }
         return _loc1_;
      }
