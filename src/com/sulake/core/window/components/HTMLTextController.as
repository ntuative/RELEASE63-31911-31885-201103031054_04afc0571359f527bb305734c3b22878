package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_944:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_748:String;
      
      private var var_1146:String = null;
      
      private var var_1785:StyleSheet = null;
      ...
      {
         this.var_748 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1146 == param2)
         {
            return;
         }
         param1.var_1146 = param2;
         param1.var_1785 = null;
         if(param1.var_1146 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1146);
            param1.var_1785 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_711.indexOf(param1) > -1)
         {
            this.var_748 = param1;
         }
      }
      ...
      {
         return this.var_748 == LinkTarget.const_31 ? defaultLinkTarget : this.var_748;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_1785;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_748 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_772,this.var_748,PropertyStruct.const_53,true,PropertyDefaults.const_711));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1533);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_772)
            {
               this.var_748 = _loc2_.value as String;
               break;
            }
