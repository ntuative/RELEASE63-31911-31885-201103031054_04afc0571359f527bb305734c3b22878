package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_427:IScrollbarWindow;
      
      private var var_1829:Boolean = true;
      ...
      override public function dispose() : void
      {
         if(this.var_427)
         {
            this.var_427.removeEventListener(WindowEvent.const_304,this.scrollBarEventProc);
            this.var_427.removeEventListener(WindowEvent.const_225,this.scrollBarEventProc);
            this.var_427 = null;
         }
         if(this.var_1162)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1162)
         {
            this.var_1162 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_427)
         {
            this.var_427 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_427)
            {
               this.var_427.addEventListener(WindowEvent.const_304,this.scrollBarEventProc);
               this.var_427.addEventListener(WindowEvent.const_225,this.scrollBarEventProc);
            }
         }
         return this.var_427;
      }
      ...
      {
         if(param1.type == WindowEvent.const_304)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_225)
         {
            this.hideScrollBar();
         }
      }
