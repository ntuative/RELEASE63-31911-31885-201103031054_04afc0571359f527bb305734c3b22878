package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_197:ISelectableWindow;
      
      protected var var_1990:Boolean = true;
      ...
      {
         return this.var_197 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         if(param1 != null)
         {
            if(param1 != this.var_197)
            {
               if(this.var_197 != null)
               {
                  this.var_197.unselect();
               }
               this.var_197 = param1;
               this.var_197.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_370,this,this.var_197));
               }
            }
         }
      }
