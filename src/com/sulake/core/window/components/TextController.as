package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1222:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_803:Number;
      
      protected var var_530:Number;
      
      protected var var_531:Boolean;
      
      protected var var_38:TextMargins;
      
      protected var _autoSize:String = "none";
      
      protected var var_119:Boolean = false;
      
      protected var var_999:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_420,this._explicitStyle);
      ...
      private static function setTextMarginMap(param1:TextController, param2:Map) : void
      {
         if(param1.var_38)
         {
            param1.var_38.assign(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         else
         {
            param1.var_38 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         }
         param1.refreshTextImage();
      }
      ...
      {
         if(param1.var_38 && param1.var_38.left != param2)
         {
      ...
      {
         if(param1.var_38 && param1.var_38.top != param2)
         {
      ...
      {
         if(param1.var_38 && param1.var_38.right != param2)
         {
      ...
      {
         if(param1.var_38 && param1.var_38.bottom != param2)
         {
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_420 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_420,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_178);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_725 ? true : null;
         }
      ...
      {
         this.var_803 = param1;
         this._field.scrollH = this.var_803 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_803 * this.maxScrollH,this.var_530 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_803 = this.var_803;
         _loc1_.var_530 = this.var_530;
         _loc1_.var_38 = this.var_38.clone(_loc1_.setTextMargins);
         _loc1_._autoSize = this._autoSize;
         _loc1_.var_119 = this.var_119;
         return _loc1_;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!this.var_531)
         {
            if(param2.type == WindowNotifyEvent.const_190)
            {
      ...
      protected function refreshTextImage(param1:Boolean = false) : void
      {
         ...
         this.var_531 = true;
         var _loc2_:int = this.var_38.left + this.var_38.right;
         var _loc3_:int = this.var_38.top + this.var_38.bottom;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1051) ? new PropertyStruct(PropertyDefaults.const_684,this._field.antiAliasType,PropertyStruct.const_53,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1186) : PropertyDefaults.const_1491);
         _loc1_.push(this._autoSize != PropertyDefaults.const_986 ? new PropertyStruct(PropertyDefaults.const_875,this._autoSize,PropertyStruct.const_53,true,PropertyDefaults.const_1010) : PropertyDefaults.const_1431);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_36,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_149,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_221,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1154 ? new PropertyStruct(PropertyDefaults.const_1084,this._field.gridFitType,PropertyStruct.const_53,true,PropertyDefaults.const_1184) : PropertyDefaults.const_1545);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_835) ? new PropertyStruct(PropertyDefaults.const_345,this._field.textColor,PropertyStruct.const_149,true) : PropertyDefaults.const_1127);
         ...
         _loc1_.push(this.var_38.left != PropertyDefaults.const_798 ? new PropertyStruct(PropertyDefaults.const_258,this.var_38.left,PropertyStruct.const_39,true) : PropertyDefaults.const_466);
         _loc1_.push(this.var_38.top != PropertyDefaults.const_716 ? new PropertyStruct(PropertyDefaults.const_237,this.var_38.top,PropertyStruct.const_39,true) : PropertyDefaults.const_437);
         _loc1_.push(this.var_38.right != PropertyDefaults.const_734 ? new PropertyStruct(PropertyDefaults.const_222,this.var_38.right,PropertyStruct.const_39,true) : PropertyDefaults.const_506);
         _loc1_.push(this.var_38.bottom != PropertyDefaults.const_885 ? new PropertyStruct(PropertyDefaults.const_270,this.var_38.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_537);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_984 ? new PropertyStruct(PropertyDefaults.const_691,this._field.mouseWheelEnabled,PropertyStruct.const_36,true) : PropertyDefaults.const_1377);
         _loc1_.push(new PropertyStruct("max_chars",this._field.maxChars,PropertyStruct.const_39,this._field.maxChars != 0));
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_228,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_228,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_228,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
