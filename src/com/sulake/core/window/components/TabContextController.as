package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1316:String = "_SELECTOR";
      
      private static const const_1315:String = "_CONTENT";
       
      
      protected var var_998:ITabSelectorWindow;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_998 = findChildByTag(const_1316) as ITabSelectorWindow;
            if(this.var_998 != null)
            {
               this.var_998.procedure = this.selectorEventProc;
            }
         }
         return this.var_998;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1991 = findChildByTag(const_1315) as IWindowContainer;
         }
      ...
      {
         return this.var_998.numSelectables;
      }
