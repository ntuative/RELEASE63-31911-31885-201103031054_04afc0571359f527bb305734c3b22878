package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1126:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1221:String = "_COLORIZE";
      
      protected static const const_1673:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1398:Point = new Point();
      ...
      protected var var_649:Function;
      
      protected var var_165:Boolean = true;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_775 = _loc13_.blend;
            var_445 = _loc13_.var_2736;
            if(var_444 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_226 != _loc13_.color)
            {
      ...
      {
         return this.var_649 != null ? this.var_649 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      
      public function get filters() : Array
      {
         return !!this.method_1() ? this.getGraphicContext(true).filters : [];
      }
      ...
      {
         var_444 = param1;
         var_226 = !!var_444 ? uint(var_226 | var_529) : uint(var_226 & 16777215);
         this.var_165 = this.var_165 || param1;
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      {
         var_802 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_574,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_529 = param1 & 4278190080;
         var_226 = !!var_444 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      ...
      {
         var_529 = param1 << 24;
         var_226 = !!var_444 ? uint(var_529 | var_226) : uint(16777215 & var_226);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
      }
      
      public function set blend(param1:Number) : void
      {
         var_775 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_11,WindowRedrawFlag.const_1083);
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_81 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_427,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_353 = this._parent.rectangle.clone();
               var_61.x = var_11.x;
               var_61.y = var_11.y;
               var_61.width = var_11.width;
               var_61.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_527,this,this._parent));
            }
            else
            {
               this.var_353.x = 0;
               this.var_353.y = 0;
               this.var_353.width = 0;
               this.var_353.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1201,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_759,var_11);
            this.var_21.visible = var_378;
         }
         return this.var_21;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_18,_context,var_11,null,this.var_649,this.properties,var_801.concat(),_id) as WindowController;
         _loc2_.var_445 = var_445;
         _loc2_.var_165 = this.var_165;
         _loc2_._debug = this._debug;
         _loc2_.var_353 = this.var_353.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2417 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_433)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            _loc7_ = uint(var_18 & 0);
            if(_loc7_ == WindowParam.const_452)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_536)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1163,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_629,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_546,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_190,this,null));
            }
         }
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_837))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_44:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_976;
                  ...
                  if((var_18 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_279))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_190:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_434,this,null));
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_164))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_183,WindowParam.const_159))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_18 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_319,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_546:
                  _context.invalidate(this,var_11.union(var_61),WindowRedrawFlag.const_570);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1081,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_309,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_344:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_726,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_272,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_423:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1094);
                  break;
               case WindowNotifyEvent.const_427:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1673) == -1)
                     {
                        _loc8_.style = var_81;
                     }
                  }
               ...
               case WindowNotifyEvent.const_574:
                  if(!(var_18 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_570);
                     }
                  }
                  else if(var_18 & 0)
                  {
               ...
               case WindowNotifyEvent.const_527:
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_69);
                  break;
               case WindowNotifyEvent.const_272:
                  this.activate();
                  break;
               case WindowNotifyEvent.const_434:
                  this._parent.getRegionProperties(null,this.var_353);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_360:
                  ...
                  break;
               case WindowNotifyEvent.const_309:
                  if(testParamFlag(WindowParam.const_65))
                  {
                     expandToAccommodateChild(this,WindowNotifyEvent(param2).related);
                  }
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            case WindowNotifyEvent.const_629:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_190:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1163:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_546:
            ...
            case WindowNotifyEvent.const_1024:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1394:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1602:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_370:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_626:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_669:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_977:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_657:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1133:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1204:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1190:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1143:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1048:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1155:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1086:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1180:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1209:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_360:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1201:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_694:
               _loc2_ = "null";
         ...
         if(_loc2_ == WindowEvent.const_162)
         {
         ...
         if(this.var_165 && var_445 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1398,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1398,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_154,WindowParam.const_164);
         var _loc2_:* = !testParamFlag(WindowParam.const_148,WindowParam.const_159);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_353.width;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_355)
               {
                  _loc3_.width += _loc4_;
               }
               ...
               else if(_loc5_ == WindowParam.const_171)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_353.height;
               _loc5_ = uint(var_18 & 0);
               if(_loc5_ == WindowParam.const_290)
               {
      ...
      {
         if(_state == WindowState.const_554)
         {
            return true;
         }
         _state = WindowState.const_554;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1088,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         }
         _loc1_.type = WindowNotifyEvent.const_1196;
         this.update(this,_loc1_);
         this.dispose();
         return true;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1143,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1086;
         this.update(this,_loc1_);
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1003,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_344;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1151,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         this.setStateFlag(WindowState.const_68,false);
         _loc1_.type = WindowNotifyEvent.const_1074;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_657;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1133,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_799;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1170;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1180,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_1209;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function populate(param1:Array) : void
      {
         ...
         for each(_loc3_ in param1)
         {
            if(_loc3_ && _loc3_.parent != this)
            {
               ...
               _loc3_.parent = this;
               _loc2_ = _loc2_ || _loc3_.method_1();
            }
         }
         if(this.var_1127 || _loc2_)
         {
            this.setupGraphicsContext();
         }
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1127 || _loc2_.method_1())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_360,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1127 || _loc3_.method_1())
         {
            this.setupGraphicsContext();
      ...
      public function swapChildren(param1:IWindow, param2:IWindow) : void
      {
         ...
         if(param1 != null && param2 != null && param1 != param2)
         {
            ...
            if(WindowController(param1).method_1() || WindowController(param2).method_1())
            {
