package com.sulake.core.window.utils
{
   ...
   public class Iterator extends Proxy implements IIterator
   {
      ...
      private static const const_1317:uint = 0;
      
      private static const const_211:uint = 1;
      
      private static const const_208:uint = 2;
      
      private static const const_209:uint = 3;
      
      private static const const_210:uint = 4;
      
      private static const const_207:uint = 5;
      ...
      public function Iterator(param1:WindowController)
      {
         ...
         {
            this._type = Iterator.const_207;
         }
         else if(this.var_36 is IItemGridWindow)
         {
            this._type = Iterator.const_210;
         }
         else if(this.var_36 is IItemListWindow)
         {
            this._type = Iterator.const_209;
         }
         else if(this.var_36 is ISelectorWindow)
         {
            this._type = Iterator.const_208;
         }
         else if(this.var_36 is IWindowContainer)
         {
            this._type = Iterator.const_211;
         }
         else
         {
            this._type = Iterator.const_1317;
         }
      }
