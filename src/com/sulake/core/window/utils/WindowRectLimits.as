package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_301:int = 2.147483647E9;
      ...
      {
         this.var_299 = param1;
         if(this.var_299 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_299)
         {
      ...
      {
         this.var_301 = param1;
         if(this.var_301 < int.MAX_VALUE && !this._target.disposed && this._target.height > this.var_301)
         {
      ...
      {
         return this.var_302 == int.MIN_VALUE && this.var_300 == int.MAX_VALUE && this.var_299 == int.MIN_VALUE && this.var_301 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            if(this._target.height < this.var_299)
            {
               this._target.height = this.var_299;
            }
            else if(this._target.height > this.var_301)
            {
               this._target.height = this.var_301;
            }
         }
