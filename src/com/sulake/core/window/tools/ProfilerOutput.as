package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1384:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1383:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_148:IProfiler;
      
      private var var_23:ICore;
      
      private var _window:IFrameWindow;
      
      private var var_2781:Array;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2781 = new Array();
         this.var_148 = this.profiler;
         this._windowManager = param2;
         this.var_839 = param3;
         var _loc4_:ByteArray = new var_1384() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_148)
         {
            this.var_148.removeStopEventListener(this.refresh);
            this.var_148 = null;
         }
         if(!this.var_148 && param1)
         {
            this.var_148 = param1;
            this.var_148.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_797)
            {
               this.var_1720 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_148.getProfilerAgentsInArray();
         ...
         if(this.var_1720)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_148.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_148.numBitmapAssetInstances + " / " + this.var_148.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_839.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_148.numTrackedBitmapDataInstances + " / " + this.var_148.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1383() as ByteArray;
