package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      private var var_144:ByteArray;
      
      private var psize:int;
      
      private var var_107:int;
      ...
      public function Random(param1:Class = null)
      {
         ...
         this.var_144 = new ByteArray();
         this.var_107 = 0;
         while(this.var_107 < this.psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = this.var_107++;
            this.var_144[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            this.var_144[_loc4_ = this.var_107++] = _loc2_ & 255;
         }
         this.var_107 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = this.var_107++;
         this.var_144[_loc2_] ^= param1 & 255;
         var _loc3_:* = this.var_107++;
         this.var_144[_loc3_] ^= param1 >> 8 & 255;
         var _loc4_:*;
         this.var_144[_loc4_ = this.var_107++] = this.var_144[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_144[_loc5_ = this.var_107++] = this.var_144[_loc5_] ^ param1 >> 24 & 255;
         this.var_107 %= this.psize;
         this.var_2154 = true;
      }
      ...
      public function nextByte() : int
      {
         if(!this.ready)
         {
            ...
            this.state.init(this.var_144);
            this.var_144.length = 0;
            this.var_107 = 0;
            this.ready = true;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_144[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         this.var_144.length = 0;
         this.var_144 = null;
