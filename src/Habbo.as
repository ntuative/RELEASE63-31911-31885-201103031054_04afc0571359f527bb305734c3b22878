package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_14:String = "error_desc";
      
      public static const const_12:String = "error_cat";
      ...
      public static const const_6:String = "byteBarSprite";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_15] = 0;
            _loc6_[const_14] = param1;
            _loc6_[const_12] = String(param2);
            if(param3 != null)
            {
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc10_:Sprite = _loc9_.getChildByName(const_6) as Sprite;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
